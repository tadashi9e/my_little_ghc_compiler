      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 273:  // main/1
      ...
      MACRO_write_variable(reg::x(3));
      MACRO_spawn(54,274,atom(29));  // spawn(outstream/1)
    case 274:  // return_from_spawn(outstream/1)
      MACRO_par(1,4);
      MACRO_out_constant(atom(128),reg::out(1));
      MACRO_spawn(267,275,atom(122));  // spawn(dump_to_dot/1)
    case 275:  // return_from_spawn(dump_to_dot/1)
      MACRO_tail(2,4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(276,2);  // execute(writes/2)
    case 276:  // writes/2
...
void setup(Program* prog) {
  ...
  atom(127) = to_atom("Hello ", 0);
  atom(128) = to_atom("dump/hello.dot", 0);
  atom(129) = to_atom("writes", 2);
  atom(130) = to_atom(" ", 0);
  // setup entry points
  ...
  prog->add_entry_point(atom(129), 276);  // writes / 2
}
int

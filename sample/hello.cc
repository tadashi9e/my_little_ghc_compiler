      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 264:  // main/1
      ...
      MACRO_write_variable(reg::x(3));
      MACRO_spawn(46,265);  // spawn(outstream/1)
    case 265:  // return_from_spawn(outstream/1)
      MACRO_par(4);
      MACRO_out_constant(atom(123),reg::out(1));
      MACRO_spawn(258,266);  // spawn(dump_to_dot/1)
    case 266:  // return_from_spawn(dump_to_dot/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(267,2);  // execute(writes/2)
    case 267:  // writes/2
...
void setup(Program* prog) {
  ...
  atom(123) = to_atom("dump/hello.dot", 0);
  atom(124) = to_atom("writes", 2);
  atom(125) = to_atom(" ", 0);
  // setup entry points
  ...
  prog->add_entry_point(atom(124), 267);  // writes / 2
}
int

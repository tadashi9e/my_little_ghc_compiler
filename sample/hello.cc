      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 254:  // main/1
      ...
      MACRO_spawn(46,255);  // spawn(outstream/1)
    case 255:  // return_from_spawn(outstream/1)
      MACRO_par(5);
      MACRO_out_constant(atom(119),reg::out(1));
      MACRO_spawn(248,256);  // spawn(dump_to_dot/1)
    case 256:  // return_from_spawn(dump_to_dot/1)
      MACRO_tail(5);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(257,2);  // execute(writes/2)
    case 257:  // writes/2
      MACRO_goal(257,atom(120));
      MACRO_requires(10);
...
void setup(Program* prog) {
  ...
  atom(118) = to_atom("Hello ", 0);
  atom(119) = to_atom("dump/hello.dot", 0);
  atom(120) = to_atom("writes", 2);
  atom(121) = to_atom(" ", 0);
  // setup entry points
  ...
  prog->add_entry_point(atom(120), 257);  // writes / 2
}
int

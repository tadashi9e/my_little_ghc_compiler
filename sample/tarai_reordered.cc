      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 270:  // return_from_call(__dec__/2)
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::x(7),reg::out(4));
      MACRO_spawn(266,271);  // spawn(tarai/4)
    case 271:  // return_from_spawn(tarai/4)
      MACRO_par(9);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(220,272);  // call(__dec__/2)
    case 272:  // return_from_call(__dec__/2)
      ...
      MACRO_out_value(reg::in(1),reg::out(3));
      MACRO_out_value(reg::x(6),reg::out(4));
      MACRO_spawn(266,273);  // spawn(tarai/4)
    case 273:  // return_from_spawn(tarai/4)
      MACRO_par(9);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(6),reg::out(2));
      MACRO_call(220,274);  // call(__dec__/2)
    case 274:  // return_from_call(__dec__/2)
      ...
      MACRO_execute(266,4);  // execute(tarai/4)
    case 275:  // report/1
    ...
    case 276:  // main/1
      ...
      MACRO_spawn(42,277);  // spawn(atom_number/2)
    ...
    case 279:  // return_from_spawn(atom_number/2)
      MACRO_par(6);
      MACRO_out_variable(reg::x(5),reg::out(1));
      MACRO_spawn(275,280);  // spawn(report/1)
    case 280:  // return_from_spawn(report/1)
      MACRO_par(6);
      MACRO_out_value(reg::x(5),reg::out(1));
      MACRO_spawn(7,281);  // spawn(wait_time/1)
    case 281:  // return_from_spawn(wait_time/1)
      MACRO_tail(6);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_out_value(reg::x(4),reg::out(3));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(123), 266);  // tarai / 4
  prog->add_entry_point(atom(124), 275);  // report / 1
  prog->add_entry_point(atom(125), 276);  // main / 1
}
int

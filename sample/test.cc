...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(234) = to_atom("xxx", 0);
    atom(235) = to_atom("dump/calc.dot", 0);
    ...
    prog->add_entry_point(atom(121), &&L264);  // test_otherwise / 0
    prog->add_entry_point(atom(122), &&L266);  // test_otherwise_aux / 1
    prog->add_entry_point(atom(125), &&L268);  // test_write_var / 0
    prog->add_entry_point(atom(126), &&L269);  // test_write_atom / 0
    prog->add_entry_point(atom(128), &&L270);  // test_write_list / 0
    prog->add_entry_point(atom(129), &&L271);  // test_write_structure / 0
    prog->add_entry_point(atom(134), &&L272);  // test_get_structure / 0
    prog->add_entry_point(atom(135), &&L273);  // test_set_structure / 0
    prog->add_entry_point(atom(136), &&L274);  // test_get_list / 0
    prog->add_entry_point(atom(137), &&L275);  // test_set_list / 0
    prog->add_entry_point(atom(138), &&L276);  // test_check_constant / 0
    prog->add_entry_point(atom(139), &&L277);  // test_check_constant_aux / 1
    prog->add_entry_point(atom(143), &&L280);  // test_check_list / 0
    prog->add_entry_point(atom(146), &&L281);  // test_check_list_aux / 1
    prog->add_entry_point(atom(151), &&L284);  // test_check_nil / 0
    prog->add_entry_point(atom(152), &&L285);  // test_check_nil_aux / 1
    prog->add_entry_point(atom(155), &&L288);  // test_check_structure / 0
    prog->add_entry_point(atom(157), &&L289);  // test_check_structure_aux / 1
    prog->add_entry_point(atom(160), &&L292);  // test_wait_var / 0
    prog->add_entry_point(atom(161), &&L294);  // wait_var / 1
    prog->add_entry_point(atom(162), &&L295);  // write_var / 1
    prog->add_entry_point(atom(164), &&L296);  // test_atom_concat / 0
    prog->add_entry_point(atom(165), &&L299);  // test_atom_concat_1 / 0
    prog->add_entry_point(atom(169), &&L304);  // test_atom_concat_2 / 0
    prog->add_entry_point(atom(173), &&L308);  // test_atom_concat_3 / 0
    prog->add_entry_point(atom(175), &&L312);  // test_atom_chars / 0
    prog->add_entry_point(atom(176), &&L314);  // test_atom_chars1 / 0
    prog->add_entry_point(atom(179), &&L318);  // test_atom_chars2 / 0
    prog->add_entry_point(atom(195), &&L322);  // test_atom_codes / 0
    prog->add_entry_point(atom(196), &&L324);  // test_atom_codes1 / 0
    prog->add_entry_point(atom(197), &&L328);  // test_atom_codes2 / 0
    prog->add_entry_point(atom(198), &&L332);  // test_append / 0
    prog->add_entry_point(atom(199), &&L335);  // test_append1 / 0
    prog->add_entry_point(atom(202), &&L342);  // test_append2 / 0
    prog->add_entry_point(atom(204), &&L349);  // test_append3 / 0
    prog->add_entry_point(atom(207), &&L356);  // test_reverse / 0
    prog->add_entry_point(atom(208), &&L358);  // test_nth0 / 0
    prog->add_entry_point(atom(209), &&L360);  // test_nth0_ / 0
    prog->add_entry_point(atom(216), &&L379);  // test_nth0_rev_ / 0
    prog->add_entry_point(atom(224), &&L403);  // test_nth1 / 0
    prog->add_entry_point(atom(225), &&L405);  // test_nth1_ / 0
    prog->add_entry_point(atom(227), &&L421);  // test_nth1_rev_ / 0
    prog->add_entry_point(atom(228), &&L441);  // test_splice_suspension / 0
    prog->add_entry_point(atom(230), &&L446);  // test_splice_suspension1 / 1
    prog->add_entry_point(atom(231), &&L447);  // test_calc / 0
    prog->add_entry_point(atom(236), &&L456);  // do_test / 1
    prog->add_entry_point(atom(238), &&L459);  // main / 1
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
 ...
 L264:  // test_otherwise/0
  ...
  MACRO_spawn(L266, L265);  // spawn(test_otherwise_aux/1)
 L265:  // return_from_spawn(test_otherwise_aux/1)
  MACRO_get_constant(tagvalue<TAG_INT>(1),reg::x(1));
  MACRO_proceed;
 L266:  // test_otherwise_aux/1
  MACRO_goal(L266, atom(122));
  MACRO_requires(3);
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L267:  // test_otherwise_aux/1-2
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(124),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L268:  // test_write_var/0
  ...
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L269:  // test_write_atom/0
  MACRO_goal(L269, atom(126));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L270:  // test_write_list/0
  MACRO_goal(L270, atom(128));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_write_void;
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L271:  // test_write_structure/0
  MACRO_goal(L271, atom(129));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L272:  // test_get_structure/0
  MACRO_goal(L272, atom(134));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L273:  // test_set_structure/0
  MACRO_goal(L273, atom(135));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L274:  // test_get_list/0
  MACRO_goal(L274, atom(136));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L275:  // test_set_list/0
  MACRO_goal(L275, atom(137));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L276:  // test_check_constant/0
  MACRO_goal(L276, atom(138));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_constant(tagvalue<TAG_INT>(1),reg::out(1));
  MACRO_execute(L277, 1);  // execute(test_check_constant_aux/1)
 L277:  // test_check_constant_aux/1
  MACRO_goal(L277, atom(139));
  MACRO_requires(3);
  MACRO_try_guard_else(L278);
  MACRO_check_constant(tagvalue<TAG_INT>(0),reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(140),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L278:  // test_check_constant_aux/1-2
  MACRO_try_guard_else(L279);
  MACRO_check_constant(tagvalue<TAG_INT>(1),reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(141),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L279:  // test_check_constant_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(142),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L280:  // test_check_list/0
  MACRO_goal(L280, atom(143));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_write_nil;
  MACRO_execute(L281, 1);  // execute(test_check_list_aux/1)
 L281:  // test_check_list_aux/1
  MACRO_goal(L281, atom(146));
  MACRO_requires(3);
  MACRO_try_guard_else(L282);
  MACRO_check_list(reg::in(1));
 ...
 L282:  // test_check_list_aux/1-2
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L283:  // test_check_list_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(142),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L284:  // test_check_nil/0
  MACRO_goal(L284, atom(151));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_nil(reg::out(1));
  MACRO_execute(L285, 1);  // execute(test_check_nil_aux/1)
 L285:  // test_check_nil_aux/1
  MACRO_goal(L285, atom(152));
  MACRO_requires(3);
  MACRO_try_guard_else(L286);
  MACRO_check_list(reg::in(1));
  MACRO_read_constant(atom(144));
  MACRO_read_list;
  MACRO_read_constant(atom(145));
 ...
 L286:  // test_check_nil_aux/1-2
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L287:  // test_check_nil_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(142),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L288:  // test_check_structure/0
  MACRO_goal(L288, atom(155));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_write_constant(atom(144));
  MACRO_write_constant(atom(145));
  MACRO_execute(L289, 1);  // execute(test_check_structure_aux/1)
 L289:  // test_check_structure_aux/1
  MACRO_goal(L289, atom(157));
  MACRO_requires(3);
  MACRO_try_guard_else(L290);
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L290:  // test_check_structure_aux/1-2
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L291:  // test_check_structure_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(142),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L292:  // test_wait_var/0
  MACRO_goal(L292, atom(160));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_spawn(L294, L293);  // spawn(wait_var/1)
 L293:  // return_from_spawn(wait_var/1)
  MACRO_tail(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L295, 1);  // execute(write_var/1)
 L294:  // wait_var/1
  MACRO_goal(L294, atom(161));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_wait(reg::in(1));
  MACRO_activate;
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L295:  // write_var/1
  MACRO_goal(L295, atom(162));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_get_constant(atom(163),reg::in(1));
  MACRO_proceed;
 L296:  // test_atom_concat/0
  MACRO_goal(L296, atom(164));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L299, L297);  // spawn(test_atom_concat_1/0)
 L297:  // return_from_spawn(test_atom_concat_1/0)
  MACRO_par(2);
  MACRO_spawn(L304, L298);  // spawn(test_atom_concat_2/0)
 L298:  // return_from_spawn(test_atom_concat_2/0)
  MACRO_tail(2);
  MACRO_execute(L308, 0);  // execute(test_atom_concat_3/0)
 L299:  // test_atom_concat_1/0
  MACRO_goal(L299, atom(165));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  ...
  MACRO_spawn(L12, L300);  // spawn(atom_concat/3)
 L300:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(168),reg::out(1));
  MACRO_spawn(L108, L301);  // spawn(write/1)
 L301:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_constant(atom(57),reg::out(1));
  MACRO_spawn(L108, L302);  // spawn(write/1)
 L302:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L303);  // spawn(write/1)
 L303:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(58),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L304:  // test_atom_concat_2/0
  MACRO_goal(L304, atom(169));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  ...
  MACRO_spawn(L12, L305);  // spawn(atom_concat/3)
 L305:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(171),reg::out(1));
  MACRO_spawn(L108, L306);  // spawn(write/1)
 L306:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L307);  // spawn(write/1)
 L307:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(172),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L308:  // test_atom_concat_3/0
  ...
  MACRO_out_constant(atom(167),reg::out(2));
  MACRO_out_constant(atom(170),reg::out(3));
  MACRO_spawn(L12, L309);  // spawn(atom_concat/3)
 L309:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(57),reg::out(1));
  MACRO_spawn(L108, L310);  // spawn(write/1)
 L310:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L311);  // spawn(write/1)
 L311:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(174),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L312:  // test_atom_chars/0
  MACRO_goal(L312, atom(175));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L314, L313);  // spawn(test_atom_chars1/0)
 L313:  // return_from_spawn(test_atom_chars1/0)
  MACRO_tail(2);
  MACRO_execute(L318, 0);  // execute(test_atom_chars2/0)
 L314:  // test_atom_chars1/0
  MACRO_goal(L314, atom(176));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L33, L315);  // spawn(atom_chars/2)
 L315:  // return_from_spawn(atom_chars/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L316);  // spawn(write/1)
 L316:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(178),reg::out(1));
  MACRO_spawn(L108, L317);  // spawn(write/1)
 L317:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L318:  // test_atom_chars2/0
  MACRO_goal(L318, atom(179));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L33, L319);  // spawn(atom_chars/2)
 L319:  // return_from_spawn(atom_chars/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L320);  // spawn(write/1)
 L320:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(194),reg::out(1));
  MACRO_spawn(L108, L321);  // spawn(write/1)
 L321:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L322:  // test_atom_codes/0
  MACRO_goal(L322, atom(195));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L324, L323);  // spawn(test_atom_codes1/0)
 L323:  // return_from_spawn(test_atom_codes1/0)
  MACRO_tail(2);
  MACRO_execute(L328, 0);  // execute(test_atom_codes2/0)
 L324:  // test_atom_codes1/0
  MACRO_goal(L324, atom(196));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(2));
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L24, L325);  // spawn(atom_codes/2)
 L325:  // return_from_spawn(atom_codes/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L326);  // spawn(write/1)
 L326:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(178),reg::out(1));
  MACRO_spawn(L108, L327);  // spawn(write/1)
 L327:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L328:  // test_atom_codes2/0
  MACRO_goal(L328, atom(197));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_spawn(L24, L329);  // spawn(atom_codes/2)
 L329:  // return_from_spawn(atom_codes/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L330);  // spawn(write/1)
 L330:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(194),reg::out(1));
  MACRO_spawn(L108, L331);  // spawn(write/1)
 L331:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L332:  // test_append/0
  MACRO_goal(L332, atom(198));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L335, L333);  // spawn(test_append1/0)
 L333:  // return_from_spawn(test_append1/0)
  MACRO_par(2);
  MACRO_spawn(L342, L334);  // spawn(test_append2/0)
 L334:  // return_from_spawn(test_append2/0)
  MACRO_tail(2);
  MACRO_execute(L349, 0);  // execute(test_append3/0)
 L335:  // test_append1/0
  MACRO_goal(L335, atom(199));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L224, L336);  // spawn(append/3)
 L336:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L337);  // spawn(write/1)
 L337:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(200),reg::out(1));
  MACRO_spawn(L108, L338);  // spawn(write/1)
 L338:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L339);  // spawn(write/1)
 L339:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(201),reg::out(1));
  MACRO_spawn(L108, L340);  // spawn(write/1)
 L340:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L108, L341);  // spawn(write/1)
 L341:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_constant(atom(58),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L342:  // test_append2/0
  MACRO_goal(L342, atom(202));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(2));
  ...
  MACRO_spawn(L224, L343);  // spawn(append/3)
 L343:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L344);  // spawn(write/1)
 L344:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(200),reg::out(1));
  MACRO_spawn(L108, L345);  // spawn(write/1)
 L345:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(57),reg::out(1));
  MACRO_spawn(L108, L346);  // spawn(write/1)
 L346:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L108, L347);  // spawn(write/1)
 L347:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(203),reg::out(1));
  MACRO_spawn(L108, L348);  // spawn(write/1)
 L348:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L349:  // test_append3/0
  MACRO_goal(L349, atom(204));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L224, L350);  // spawn(append/3)
 L350:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_constant(atom(57),reg::out(1));
  MACRO_spawn(L108, L351);  // spawn(write/1)
 L351:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L108, L352);  // spawn(write/1)
 L352:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(205),reg::out(1));
  MACRO_spawn(L108, L353);  // spawn(write/1)
 L353:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L354);  // spawn(write/1)
 L354:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(206),reg::out(1));
  MACRO_spawn(L108, L355);  // spawn(write/1)
 L355:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L356:  // test_reverse/0
  MACRO_goal(L356, atom(207));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L232, L357);  // spawn(reverse/2)
 L357:  // return_from_spawn(reverse/2)
  MACRO_tail(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L358:  // test_nth0/0
  MACRO_goal(L358, atom(208));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L360, L359);  // spawn(test_nth0_/0)
 L359:  // return_from_spawn(test_nth0_/0)
  MACRO_tail(2);
  MACRO_execute(L379, 0);  // execute(test_nth0_rev_/0)
 L360:  // test_nth0_/0
  MACRO_goal(L360, atom(209));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L238, L361);  // spawn(nth0/3)
 L361:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(210),reg::out(1));
  MACRO_spawn(L108, L362);  // spawn(write/1)
 L362:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L363);  // spawn(write/1)
 L363:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(1),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L238, L364);  // spawn(nth0/3)
 L364:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(211),reg::out(1));
  MACRO_spawn(L108, L365);  // spawn(write/1)
 L365:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L366);  // spawn(write/1)
 L366:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L238, L367);  // spawn(nth0/3)
 L367:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(212),reg::out(1));
  MACRO_spawn(L108, L368);  // spawn(write/1)
 L368:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L369);  // spawn(write/1)
 L369:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(3),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L238, L370);  // spawn(nth0/3)
 L370:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(213),reg::out(1));
  MACRO_spawn(L108, L371);  // spawn(write/1)
 L371:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L372);  // spawn(write/1)
 L372:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(4),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L238, L373);  // spawn(nth0/3)
 L373:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(214),reg::out(1));
  MACRO_spawn(L108, L374);  // spawn(write/1)
 L374:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L375);  // spawn(write/1)
 L375:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(5),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(1),reg::out(3));
  MACRO_spawn(L238, L376);  // spawn(nth0/3)
 L376:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(215),reg::out(1));
  MACRO_spawn(L108, L377);  // spawn(write/1)
 L377:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L378);  // spawn(write/1)
 L378:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(58),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L379:  // test_nth0_rev_/0
  MACRO_goal(L379, atom(216));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L238, L380);  // spawn(nth0/3)
 L380:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L381);  // spawn(write/1)
 L381:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L382);  // spawn(write/1)
 L382:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(218),reg::out(1));
  MACRO_spawn(L108, L383);  // spawn(write/1)
 L383:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(145),reg::out(3));
  MACRO_spawn(L238, L384);  // spawn(nth0/3)
 L384:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L385);  // spawn(write/1)
 L385:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L386);  // spawn(write/1)
 L386:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(219),reg::out(1));
  MACRO_spawn(L108, L387);  // spawn(write/1)
 L387:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(180),reg::out(3));
  MACRO_spawn(L238, L388);  // spawn(nth0/3)
 L388:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L389);  // spawn(write/1)
 L389:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L390);  // spawn(write/1)
 L390:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(220),reg::out(1));
  MACRO_spawn(L108, L391);  // spawn(write/1)
 L391:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(181),reg::out(3));
  MACRO_spawn(L238, L392);  // spawn(nth0/3)
 L392:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L393);  // spawn(write/1)
 L393:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L394);  // spawn(write/1)
 L394:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(221),reg::out(1));
  MACRO_spawn(L108, L395);  // spawn(write/1)
 L395:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(182),reg::out(3));
  MACRO_spawn(L238, L396);  // spawn(nth0/3)
 L396:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L397);  // spawn(write/1)
 L397:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L398);  // spawn(write/1)
 L398:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(222),reg::out(1));
  MACRO_spawn(L108, L399);  // spawn(write/1)
 L399:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(183),reg::out(3));
  MACRO_spawn(L238, L400);  // spawn(nth0/3)
 L400:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L401);  // spawn(write/1)
 L401:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L402);  // spawn(write/1)
 L402:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(223),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L403:  // test_nth1/0
  MACRO_goal(L403, atom(224));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L405, L404);  // spawn(test_nth1_/0)
 L404:  // return_from_spawn(test_nth1_/0)
  MACRO_tail(2);
  MACRO_execute(L421, 0);  // execute(test_nth1_rev_/0)
 L405:  // test_nth1_/0
  MACRO_goal(L405, atom(225));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L248, L406);  // spawn(nth1/3)
 L406:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(226),reg::out(1));
  MACRO_spawn(L108, L407);  // spawn(write/1)
 L407:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L408);  // spawn(write/1)
 L408:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L248, L409);  // spawn(nth1/3)
 L409:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(212),reg::out(1));
  MACRO_spawn(L108, L410);  // spawn(write/1)
 L410:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L411);  // spawn(write/1)
 L411:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(3),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L248, L412);  // spawn(nth1/3)
 L412:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(213),reg::out(1));
  MACRO_spawn(L108, L413);  // spawn(write/1)
 L413:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L414);  // spawn(write/1)
 L414:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(4),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L248, L415);  // spawn(nth1/3)
 L415:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(214),reg::out(1));
  MACRO_spawn(L108, L416);  // spawn(write/1)
 L416:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L417);  // spawn(write/1)
 L417:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(5),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(1),reg::out(3));
  MACRO_spawn(L248, L418);  // spawn(nth1/3)
 L418:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(215),reg::out(1));
  MACRO_spawn(L108, L419);  // spawn(write/1)
 L419:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L108, L420);  // spawn(write/1)
 L420:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(58),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L421:  // test_nth1_rev_/0
  MACRO_goal(L421, atom(227));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(144),reg::out(3));
  MACRO_spawn(L248, L422);  // spawn(nth1/3)
 L422:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L423);  // spawn(write/1)
 L423:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L424);  // spawn(write/1)
 L424:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(218),reg::out(1));
  MACRO_spawn(L108, L425);  // spawn(write/1)
 L425:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(145),reg::out(3));
  MACRO_spawn(L248, L426);  // spawn(nth1/3)
 L426:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L427);  // spawn(write/1)
 L427:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L428);  // spawn(write/1)
 L428:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(219),reg::out(1));
  MACRO_spawn(L108, L429);  // spawn(write/1)
 L429:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(180),reg::out(3));
  MACRO_spawn(L248, L430);  // spawn(nth1/3)
 L430:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L431);  // spawn(write/1)
 L431:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L432);  // spawn(write/1)
 L432:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(220),reg::out(1));
  MACRO_spawn(L108, L433);  // spawn(write/1)
 L433:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(181),reg::out(3));
  MACRO_spawn(L248, L434);  // spawn(nth1/3)
 L434:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L435);  // spawn(write/1)
 L435:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L436);  // spawn(write/1)
 L436:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(221),reg::out(1));
  MACRO_spawn(L108, L437);  // spawn(write/1)
 L437:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(182),reg::out(3));
  MACRO_spawn(L248, L438);  // spawn(nth1/3)
 L438:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L108, L439);  // spawn(write/1)
 L439:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L108, L440);  // spawn(write/1)
 L440:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(222),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L441:  // test_splice_suspension/0
  MACRO_goal(L441, atom(228));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_spawn(L446, L442);  // spawn(test_splice_suspension1/1)
 L442:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L446, L443);  // spawn(test_splice_suspension1/1)
 L443:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_par(4);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_spawn(L446, L444);  // spawn(test_splice_suspension1/1)
 L444:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_get_value(reg::x(2),reg::x(1));
  MACRO_get_value(reg::x(3),reg::x(2));
  MACRO_par(4);
  MACRO_out_constant(atom(229),reg::out(1));
  MACRO_spawn(L258, L445);  // spawn(dump_to_dot/1)
 L445:  // return_from_spawn(dump_to_dot/1)
  MACRO_get_constant(atom(228),reg::x(1));
  MACRO_proceed;
 L446:  // test_splice_suspension1/1
  MACRO_goal(L446, atom(230));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_wait(reg::in(1));
  MACRO_activate;
  ...
  MACRO_execute(L100, 1);  // execute(writeln/1)
 L447:  // test_calc/0
  MACRO_goal(L447, atom(231));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_constant(atom(232),reg::out(1));
  MACRO_spawn(L100, L448);  // spawn(writeln/1)
 L448:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(2),reg::out(2));
  MACRO_call(L218, L449);  // call(__dec__/2)
 L449:  // return_from_call(__dec__/2)
  MACRO_par(3);
  MACRO_out_constant(atom(233),reg::out(1));
  MACRO_spawn(L100, L450);  // spawn(writeln/1)
 L450:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  ...
  MACRO_write_constant(tagvalue<TAG_INT>(1));
  MACRO_spawn(L100, L451);  // spawn(writeln/1)
 L451:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(2),reg::out(2));
  MACRO_call(L214, L452);  // call(__inc__/2)
 L452:  // return_from_call(__inc__/2)
  MACRO_par(3);
  MACRO_out_structure(atom(83),reg::out(1));
  MACRO_write_value(reg::x(2));
  ...
  MACRO_write_value(reg::x(1));
  MACRO_write_constant(tagvalue<TAG_INT>(1));
  MACRO_spawn(L100, L453);  // spawn(writeln/1)
 L453:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_constant(atom(234),reg::out(1));
  MACRO_spawn(L100, L454);  // spawn(writeln/1)
 L454:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_constant(atom(235),reg::out(1));
  MACRO_spawn(L258, L455);  // spawn(dump_to_dot/1)
 L455:  // return_from_spawn(dump_to_dot/1)
  MACRO_get_constant(tagvalue<TAG_INT>(10),reg::x(1));
  MACRO_proceed;
 L456:  // do_test/1
  MACRO_goal(L456, atom(236));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_seq(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_call(L108, L457);  // call(write/1)
 L457:  // return_from_call(write/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(237),reg::out(1));
  MACRO_call(L100, L458);  // call(writeln/1)
 L458:  // return_from_call(writeln/1)
  MACRO_tail(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_execute(L4, 1);  // execute(time/1)
 L459:  // main/1
  MACRO_goal(L459, atom(238));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_seq(3);
  MACRO_out_constant(atom(121),reg::out(1));
  MACRO_call(L456, L460);  // call(do_test/1)
 L460:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(125),reg::out(1));
  MACRO_call(L456, L461);  // call(do_test/1)
 L461:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(126),reg::out(1));
  MACRO_call(L456, L462);  // call(do_test/1)
 L462:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(128),reg::out(1));
  MACRO_call(L456, L463);  // call(do_test/1)
 L463:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(129),reg::out(1));
  MACRO_call(L456, L464);  // call(do_test/1)
 L464:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(134),reg::out(1));
  MACRO_call(L456, L465);  // call(do_test/1)
 L465:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(135),reg::out(1));
  MACRO_call(L456, L466);  // call(do_test/1)
 L466:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(136),reg::out(1));
  MACRO_call(L456, L467);  // call(do_test/1)
 L467:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(137),reg::out(1));
  MACRO_call(L456, L468);  // call(do_test/1)
 L468:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(138),reg::out(1));
  MACRO_call(L456, L469);  // call(do_test/1)
 L469:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(143),reg::out(1));
  MACRO_call(L456, L470);  // call(do_test/1)
 L470:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(151),reg::out(1));
  MACRO_call(L456, L471);  // call(do_test/1)
 L471:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(155),reg::out(1));
  MACRO_call(L456, L472);  // call(do_test/1)
 L472:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(160),reg::out(1));
  MACRO_call(L456, L473);  // call(do_test/1)
 L473:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(164),reg::out(1));
  MACRO_call(L456, L474);  // call(do_test/1)
 L474:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(175),reg::out(1));
  MACRO_call(L456, L475);  // call(do_test/1)
 L475:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(195),reg::out(1));
  MACRO_call(L456, L476);  // call(do_test/1)
 L476:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(198),reg::out(1));
  MACRO_call(L456, L477);  // call(do_test/1)
 L477:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(207),reg::out(1));
  MACRO_call(L456, L478);  // call(do_test/1)
 L478:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(208),reg::out(1));
  MACRO_call(L456, L479);  // call(do_test/1)
 L479:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_call(L456, L480);  // call(do_test/1)
 L480:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(228),reg::out(1));
  MACRO_call(L456, L481);  // call(do_test/1)
 L481:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(231),reg::out(1));
  MACRO_call(L456, L482);  // call(do_test/1)
 L482:  // return_from_call(do_test/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L254, L483);  // spawn(inference_count/1)
 L483:  // return_from_spawn(inference_count/1)
  MACRO_par(3);
  MACRO_out_constant(atom(239),reg::out(1));
  MACRO_spawn(L108, L484);  // spawn(write/1)
 L484:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L100, 1);  // execute(writeln/1)
 LNO_MORE_GOALS:

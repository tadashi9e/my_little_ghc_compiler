...
Q atom(123);  // test_call3 / 0
Q atom(124);  // test_call3 / 1
Q atom(125);  // a / 0
Q atom(126);  // b / 0
Q atom(127);  // c / 0
Q atom(128);  // test_call3 / 3
Q atom(129);  // test_call3 / 2
Q atom(130);  // done / 0
Q atom(131);  // test_otherwise / 0
Q atom(132);  // test_otherwise_aux / 1
Q atom(133);  // test failed / 0
Q atom(134);  // test success / 0
Q atom(135);  // test_write_var / 0
Q atom(136);  // test_write_atom / 0
Q atom(137);  // atom / 0
Q atom(138);  // test_write_list / 0
Q atom(139);  // test_write_structure / 0
Q atom(140);  // some / 3
Q atom(141);  // structure / 0
Q atom(142);  // and / 0
Q atom(143);  // arguments / 0
Q atom(144);  // test_get_structure / 0
Q atom(145);  // test_set_structure / 0
Q atom(146);  // test_get_list / 0
Q atom(147);  // test_set_list / 0
Q atom(148);  // test_check_constant / 0
Q atom(149);  // test_check_constant_aux / 1
Q atom(150);  // test failed(0) / 0
Q atom(151);  // test success(1) / 0
Q atom(152);  // test failed(otherwise) / 0
Q atom(153);  // test_check_list / 0
Q atom(154);  // test_check_list_aux / 1
Q atom(155);  // x / 0
Q atom(156);  // y / 0
Q atom(157);  // test failed([x,y]) / 0
Q atom(158);  // test success([a,b]) / 0
Q atom(159);  // test_check_nil / 0
Q atom(160);  // test_check_nil_aux / 1
Q atom(161);  // test failed([a,b]) / 0
Q atom(162);  // test success([]) / 0
Q atom(163);  // test_check_structure / 0
Q atom(164);  // fun / 2
Q atom(165);  // test_check_structure_aux / 1
Q atom(166);  // test failed(fun(x,y)) / 0
Q atom(167);  // test success(fun(a,b)) / 0
Q atom(168);  // test_wait_var / 0
Q atom(169);  // wait_var / 1
Q atom(170);  // write_var / 1
Q atom(171);  // fire / 0
Q atom(172);  // test_atom_concat / 0
Q atom(173);  // test_atom_concat_1 / 0
Q atom(174);  // abc / 0
Q atom(175);  // def / 0
Q atom(176);  // abc + def =  / 0
Q atom(177);  // test_atom_concat_2 / 0
Q atom(178);  // abcdef / 0
Q atom(179);  // abc + [ / 0
Q atom(180);  // ] = abcdef / 0
Q atom(181);  // test_atom_concat_3 / 0
Q atom(182);  // ] + def = abcdef / 0
Q atom(183);  // test_atom_chars / 0
Q atom(184);  // test_atom_chars1 / 0
Q atom(185);  // abcdefgあいうえお漢字☺🍺 / 0
Q atom(186);  //  ->  / 0
Q atom(187);  // test_atom_chars2 / 0
Q atom(188);  // d / 0
Q atom(189);  // e / 0
Q atom(190);  // f / 0
Q atom(191);  // g / 0
...
Q atom(200);  // 🍺 / 0
Q atom(201);  //  <-  / 0
Q atom(202);  // test_atom_codes / 0
Q atom(203);  // test_atom_codes1 / 0
Q atom(204);  // test_atom_codes2 / 0
Q atom(205);  // test_append / 0
Q atom(206);  // test_append1 / 0
Q atom(207);  // + / 0
Q atom(208);  // =[ / 0
Q atom(209);  // test_append2 / 0
Q atom(210);  // ]= / 0
Q atom(211);  // test_append3 / 0
Q atom(212);  // ]+ / 0
Q atom(213);  // = / 0
Q atom(214);  // test_reverse / 0
Q atom(215);  // test_nth0 / 0
Q atom(216);  // test_nth0_ / 0
Q atom(217);  //  0: [ / 0
Q atom(218);  // ] 1: [ / 0
Q atom(219);  // ] 2: [ / 0
Q atom(220);  // ] 3: [ / 0
...
Q atom(229);  // ]: e / 0
Q atom(230);  // ]: f / 0
Q atom(231);  // test_nth1 / 0
Q atom(232);  // test_nth1_ / 0
Q atom(233);  //  1: [ / 0
Q atom(234);  // test_nth1_rev_ / 0
Q atom(235);  // test_splice_suspension / 0
Q atom(236);  // dump/splice.dot / 0
Q atom(237);  // test_splice_suspension1 / 1
Q atom(238);  // test_calc / 0
Q atom(239);  // xxx0 / 0
Q atom(240);  // xxx1 / 0
Q atom(241);  // xxx / 0
Q atom(242);  // dump/calc.dot / 0
Q atom(243);  // do_test / 1
Q atom(244);  // :  / 0
Q atom(245);  // main / 1
Q atom(246);  // total_inferences= / 0
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(123) = to_atom("test_call3", 0);
    atom(124) = to_atom("test_call3", 1);
    atom(125) = to_atom("a", 0);
    atom(126) = to_atom("b", 0);
    atom(127) = to_atom("c", 0);
    atom(128) = to_atom("test_call3", 3);
    atom(129) = to_atom("test_call3", 2);
    atom(130) = to_atom("done", 0);
    atom(131) = to_atom("test_otherwise", 0);
    atom(132) = to_atom("test_otherwise_aux", 1);
    atom(133) = to_atom("test failed", 0);
    atom(134) = to_atom("test success", 0);
    atom(135) = to_atom("test_write_var", 0);
    atom(136) = to_atom("test_write_atom", 0);
    atom(137) = to_atom("atom", 0);
    atom(138) = to_atom("test_write_list", 0);
    atom(139) = to_atom("test_write_structure", 0);
    atom(140) = to_atom("some", 3);
    atom(141) = to_atom("structure", 0);
    atom(142) = to_atom("and", 0);
    atom(143) = to_atom("arguments", 0);
    atom(144) = to_atom("test_get_structure", 0);
    atom(145) = to_atom("test_set_structure", 0);
    atom(146) = to_atom("test_get_list", 0);
    atom(147) = to_atom("test_set_list", 0);
    atom(148) = to_atom("test_check_constant", 0);
    atom(149) = to_atom("test_check_constant_aux", 1);
    atom(150) = to_atom("test failed(0)", 0);
    atom(151) = to_atom("test success(1)", 0);
    atom(152) = to_atom("test failed(otherwise)", 0);
    atom(153) = to_atom("test_check_list", 0);
    atom(154) = to_atom("test_check_list_aux", 1);
    atom(155) = to_atom("x", 0);
    atom(156) = to_atom("y", 0);
    atom(157) = to_atom("test failed([x,y])", 0);
    atom(158) = to_atom("test success([a,b])", 0);
    atom(159) = to_atom("test_check_nil", 0);
    atom(160) = to_atom("test_check_nil_aux", 1);
    atom(161) = to_atom("test failed([a,b])", 0);
    atom(162) = to_atom("test success([])", 0);
    atom(163) = to_atom("test_check_structure", 0);
    atom(164) = to_atom("fun", 2);
    atom(165) = to_atom("test_check_structure_aux", 1);
    atom(166) = to_atom("test failed(fun(x,y))", 0);
    atom(167) = to_atom("test success(fun(a,b))", 0);
    atom(168) = to_atom("test_wait_var", 0);
    atom(169) = to_atom("wait_var", 1);
    atom(170) = to_atom("write_var", 1);
    atom(171) = to_atom("fire", 0);
    atom(172) = to_atom("test_atom_concat", 0);
    atom(173) = to_atom("test_atom_concat_1", 0);
    atom(174) = to_atom("abc", 0);
    atom(175) = to_atom("def", 0);
    atom(176) = to_atom("abc + def = ", 0);
    atom(177) = to_atom("test_atom_concat_2", 0);
    atom(178) = to_atom("abcdef", 0);
    atom(179) = to_atom("abc + [", 0);
    atom(180) = to_atom("] = abcdef", 0);
    atom(181) = to_atom("test_atom_concat_3", 0);
    atom(182) = to_atom("] + def = abcdef", 0);
    atom(183) = to_atom("test_atom_chars", 0);
    atom(184) = to_atom("test_atom_chars1", 0);
    atom(185) = to_atom("abcdefgあいうえお漢字☺🍺", 0);
    atom(186) = to_atom(" -> ", 0);
    atom(187) = to_atom("test_atom_chars2", 0);
    atom(188) = to_atom("d", 0);
    atom(189) = to_atom("e", 0);
    atom(190) = to_atom("f", 0);
    atom(191) = to_atom("g", 0);
    atom(192) = to_atom("あ", 0);
    atom(193) = to_atom("い", 0);
    atom(194) = to_atom("う", 0);
    atom(195) = to_atom("え", 0);
    atom(196) = to_atom("お", 0);
    atom(197) = to_atom("漢", 0);
    atom(198) = to_atom("字", 0);
    atom(199) = to_atom("☺", 0);
    atom(200) = to_atom("🍺", 0);
    atom(201) = to_atom(" <- ", 0);
    atom(202) = to_atom("test_atom_codes", 0);
    atom(203) = to_atom("test_atom_codes1", 0);
    atom(204) = to_atom("test_atom_codes2", 0);
    atom(205) = to_atom("test_append", 0);
    atom(206) = to_atom("test_append1", 0);
    atom(207) = to_atom("+", 0);
    atom(208) = to_atom("=[", 0);
    atom(209) = to_atom("test_append2", 0);
    atom(210) = to_atom("]=", 0);
    atom(211) = to_atom("test_append3", 0);
    atom(212) = to_atom("]+", 0);
    atom(213) = to_atom("=", 0);
    atom(214) = to_atom("test_reverse", 0);
    atom(215) = to_atom("test_nth0", 0);
    atom(216) = to_atom("test_nth0_", 0);
    atom(217) = to_atom(" 0: [", 0);
    atom(218) = to_atom("] 1: [", 0);
    atom(219) = to_atom("] 2: [", 0);
    atom(220) = to_atom("] 3: [", 0);
    atom(221) = to_atom("] 4: [", 0);
    atom(222) = to_atom("] 5: [", 0);
    atom(223) = to_atom("test_nth0_rev_", 0);
    atom(224) = to_atom(" [", 0);
    atom(225) = to_atom("]: a", 0);
    atom(226) = to_atom("]: b", 0);
    atom(227) = to_atom("]: c", 0);
    atom(228) = to_atom("]: d", 0);
    atom(229) = to_atom("]: e", 0);
    atom(230) = to_atom("]: f", 0);
    atom(231) = to_atom("test_nth1", 0);
    atom(232) = to_atom("test_nth1_", 0);
    atom(233) = to_atom(" 1: [", 0);
    atom(234) = to_atom("test_nth1_rev_", 0);
    atom(235) = to_atom("test_splice_suspension", 0);
    atom(236) = to_atom("dump/splice.dot", 0);
    atom(237) = to_atom("test_splice_suspension1", 1);
    atom(238) = to_atom("test_calc", 0);
    atom(239) = to_atom("xxx0", 0);
    atom(240) = to_atom("xxx1", 0);
    atom(241) = to_atom("xxx", 0);
    atom(242) = to_atom("dump/calc.dot", 0);
    atom(243) = to_atom("do_test", 1);
    atom(244) = to_atom(": ", 0);
    atom(245) = to_atom("main", 1);
    atom(246) = to_atom("total_inferences=", 0);
    // setup entry points
    ...
    prog->add_entry_point(atom(123), &&L266);  // test_call3 / 0
    prog->add_entry_point(atom(128), &&L271);  // test_call3 / 3
    prog->add_entry_point(atom(129), &&L272);  // test_call3 / 2
    prog->add_entry_point(atom(131), &&L273);  // test_otherwise / 0
    prog->add_entry_point(atom(132), &&L275);  // test_otherwise_aux / 1
    prog->add_entry_point(atom(135), &&L277);  // test_write_var / 0
    prog->add_entry_point(atom(136), &&L278);  // test_write_atom / 0
    prog->add_entry_point(atom(138), &&L279);  // test_write_list / 0
    prog->add_entry_point(atom(139), &&L280);  // test_write_structure / 0
    prog->add_entry_point(atom(144), &&L281);  // test_get_structure / 0
    prog->add_entry_point(atom(145), &&L282);  // test_set_structure / 0
    prog->add_entry_point(atom(146), &&L283);  // test_get_list / 0
    prog->add_entry_point(atom(147), &&L284);  // test_set_list / 0
    prog->add_entry_point(atom(148), &&L285);  // test_check_constant / 0
    prog->add_entry_point(atom(149), &&L286);  // test_check_constant_aux / 1
    prog->add_entry_point(atom(153), &&L289);  // test_check_list / 0
    prog->add_entry_point(atom(154), &&L290);  // test_check_list_aux / 1
    prog->add_entry_point(atom(159), &&L293);  // test_check_nil / 0
    prog->add_entry_point(atom(160), &&L294);  // test_check_nil_aux / 1
    prog->add_entry_point(atom(163), &&L297);  // test_check_structure / 0
    prog->add_entry_point(atom(165), &&L298);  // test_check_structure_aux / 1
    prog->add_entry_point(atom(168), &&L301);  // test_wait_var / 0
    prog->add_entry_point(atom(169), &&L303);  // wait_var / 1
    prog->add_entry_point(atom(170), &&L304);  // write_var / 1
    prog->add_entry_point(atom(172), &&L305);  // test_atom_concat / 0
    prog->add_entry_point(atom(173), &&L308);  // test_atom_concat_1 / 0
    prog->add_entry_point(atom(177), &&L313);  // test_atom_concat_2 / 0
    prog->add_entry_point(atom(181), &&L317);  // test_atom_concat_3 / 0
    prog->add_entry_point(atom(183), &&L321);  // test_atom_chars / 0
    prog->add_entry_point(atom(184), &&L323);  // test_atom_chars1 / 0
    prog->add_entry_point(atom(187), &&L327);  // test_atom_chars2 / 0
    prog->add_entry_point(atom(202), &&L331);  // test_atom_codes / 0
    prog->add_entry_point(atom(203), &&L333);  // test_atom_codes1 / 0
    prog->add_entry_point(atom(204), &&L337);  // test_atom_codes2 / 0
    prog->add_entry_point(atom(205), &&L341);  // test_append / 0
    prog->add_entry_point(atom(206), &&L344);  // test_append1 / 0
    prog->add_entry_point(atom(209), &&L351);  // test_append2 / 0
    prog->add_entry_point(atom(211), &&L358);  // test_append3 / 0
    prog->add_entry_point(atom(214), &&L365);  // test_reverse / 0
    prog->add_entry_point(atom(215), &&L367);  // test_nth0 / 0
    prog->add_entry_point(atom(216), &&L369);  // test_nth0_ / 0
    prog->add_entry_point(atom(223), &&L388);  // test_nth0_rev_ / 0
    prog->add_entry_point(atom(231), &&L412);  // test_nth1 / 0
    prog->add_entry_point(atom(232), &&L414);  // test_nth1_ / 0
    prog->add_entry_point(atom(234), &&L430);  // test_nth1_rev_ / 0
    prog->add_entry_point(atom(235), &&L450);  // test_splice_suspension / 0
    prog->add_entry_point(atom(237), &&L455);  // test_splice_suspension1 / 1
    prog->add_entry_point(atom(238), &&L456);  // test_calc / 0
    prog->add_entry_point(atom(243), &&L465);  // do_test / 1
    prog->add_entry_point(atom(245), &&L468);  // main / 1
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
 ...
 L266:  // test_call3/0
  ...
  MACRO_activate;
  MACRO_par(3);
  MACRO_out_structure(atom(124),reg::out(1));
  MACRO_write_constant(atom(125));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L4, L267);  // spawn(call/3)
 L267:  // return_from_spawn(call/3)
  MACRO_par(3);
  MACRO_out_structure(atom(124),reg::out(1));
  MACRO_write_constant(atom(126));
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L4, L268);  // spawn(call/3)
 L268:  // return_from_spawn(call/3)
  MACRO_par(3);
  MACRO_out_structure(atom(124),reg::out(1));
  MACRO_write_constant(atom(127));
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L4, L269);  // spawn(call/3)
 L269:  // return_from_spawn(call/3)
  MACRO_par(3);
  MACRO_out_constant(atom(123),reg::out(1));
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_out_nil(reg::out(3));
  MACRO_spawn(L4, L270);  // spawn(call/3)
 L270:  // return_from_spawn(call/3)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L271:  // test_call3/3
  MACRO_goal(L271, atom(128));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
 ...
 L272:  // test_call3/2
  ...
  MACRO_proceed;
 L273:  // test_otherwise/0
  MACRO_goal(L273, atom(131));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_spawn(L275, L274);  // spawn(test_otherwise_aux/1)
 L274:  // return_from_spawn(test_otherwise_aux/1)
  MACRO_get_constant(tagvalue<TAG_INT>(1),reg::x(1));
  MACRO_proceed;
 L275:  // test_otherwise_aux/1
  MACRO_goal(L275, atom(132));
  MACRO_requires(3);
  MACRO_try_guard_else(L276);
  MACRO_check_constant(tagvalue<TAG_INT>(0),reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(133),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L276:  // test_otherwise_aux/1-2
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(134),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L277:  // test_write_var/0
  MACRO_goal(L277, atom(135));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L278:  // test_write_atom/0
  MACRO_goal(L278, atom(136));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L279:  // test_write_list/0
  MACRO_goal(L279, atom(138));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_write_void;
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L280:  // test_write_structure/0
  MACRO_goal(L280, atom(139));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_structure(atom(140),reg::out(1));
  MACRO_write_constant(atom(141));
  MACRO_write_constant(atom(142));
  MACRO_write_constant(atom(143));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L281:  // test_get_structure/0
  MACRO_goal(L281, atom(144));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  MACRO_get_structure(atom(86),reg::x(1));
  MACRO_unify_constant(tagvalue<TAG_INT>(1));
  MACRO_unify_constant(tagvalue<TAG_INT>(2));
  MACRO_tail(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L282:  // test_set_structure/0
  MACRO_goal(L282, atom(145));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_structure(atom(86),reg::x(1));
  MACRO_write_constant(tagvalue<TAG_INT>(1));
  MACRO_write_constant(tagvalue<TAG_INT>(2));
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L283:  // test_get_list/0
  MACRO_goal(L283, atom(146));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L284:  // test_set_list/0
  MACRO_goal(L284, atom(147));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L285:  // test_check_constant/0
  MACRO_goal(L285, atom(148));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_constant(tagvalue<TAG_INT>(1),reg::out(1));
  MACRO_execute(L286, 1);  // execute(test_check_constant_aux/1)
 L286:  // test_check_constant_aux/1
  MACRO_goal(L286, atom(149));
  MACRO_requires(3);
  MACRO_try_guard_else(L287);
  MACRO_check_constant(tagvalue<TAG_INT>(0),reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(150),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L287:  // test_check_constant_aux/1-2
  MACRO_try_guard_else(L288);
  MACRO_check_constant(tagvalue<TAG_INT>(1),reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(151),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L288:  // test_check_constant_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(152),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L289:  // test_check_list/0
  MACRO_goal(L289, atom(153));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  ...
  MACRO_write_constant(atom(126));
  MACRO_write_nil;
  MACRO_execute(L290, 1);  // execute(test_check_list_aux/1)
 L290:  // test_check_list_aux/1
  MACRO_goal(L290, atom(154));
  MACRO_requires(3);
  MACRO_try_guard_else(L291);
  MACRO_check_list(reg::in(1));
  MACRO_read_constant(atom(155));
  MACRO_read_list;
  MACRO_read_constant(atom(156));
  MACRO_read_nil;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(157),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L291:  // test_check_list_aux/1-2
  MACRO_try_guard_else(L292);
  MACRO_check_list(reg::in(1));
  MACRO_read_constant(atom(125));
  MACRO_read_list;
  MACRO_read_constant(atom(126));
  MACRO_read_nil;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(158),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L292:  // test_check_list_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(152),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L293:  // test_check_nil/0
  MACRO_goal(L293, atom(159));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_nil(reg::out(1));
  MACRO_execute(L294, 1);  // execute(test_check_nil_aux/1)
 L294:  // test_check_nil_aux/1
  MACRO_goal(L294, atom(160));
  MACRO_requires(3);
  MACRO_try_guard_else(L295);
  MACRO_check_list(reg::in(1));
  MACRO_read_constant(atom(125));
  MACRO_read_list;
  MACRO_read_constant(atom(126));
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L295:  // test_check_nil_aux/1-2
  MACRO_try_guard_else(L296);
  MACRO_check_nil(reg::in(1));
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(162),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L296:  // test_check_nil_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(152),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L297:  // test_check_structure/0
  MACRO_goal(L297, atom(163));
  MACRO_requires(2);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_tail(2);
  MACRO_out_structure(atom(164),reg::out(1));
  MACRO_write_constant(atom(125));
  MACRO_write_constant(atom(126));
  MACRO_execute(L298, 1);  // execute(test_check_structure_aux/1)
 L298:  // test_check_structure_aux/1
  MACRO_goal(L298, atom(165));
  MACRO_requires(3);
  MACRO_try_guard_else(L299);
  MACRO_check_structure(atom(164),reg::in(1));
  MACRO_read_constant(atom(155));
  MACRO_read_constant(atom(156));
  MACRO_activate;
  MACRO_tail(3);
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L299:  // test_check_structure_aux/1-2
  MACRO_try_guard_else(L300);
  MACRO_check_structure(atom(164),reg::in(1));
  MACRO_read_constant(atom(125));
  MACRO_read_constant(atom(126));
  MACRO_activate;
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L300:  // test_check_structure_aux/1-3
  MACRO_otherwise;
  MACRO_activate;
  MACRO_tail(3);
  MACRO_out_constant(atom(152),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L301:  // test_wait_var/0
  MACRO_goal(L301, atom(168));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_spawn(L303, L302);  // spawn(wait_var/1)
 L302:  // return_from_spawn(wait_var/1)
  MACRO_tail(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L304, 1);  // execute(write_var/1)
 L303:  // wait_var/1
  MACRO_goal(L303, atom(169));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_wait(reg::in(1));
  MACRO_activate;
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L304:  // write_var/1
  MACRO_goal(L304, atom(170));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_get_constant(atom(171),reg::in(1));
  MACRO_proceed;
 L305:  // test_atom_concat/0
  MACRO_goal(L305, atom(172));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L308, L306);  // spawn(test_atom_concat_1/0)
 L306:  // return_from_spawn(test_atom_concat_1/0)
  MACRO_par(2);
  MACRO_spawn(L313, L307);  // spawn(test_atom_concat_2/0)
 L307:  // return_from_spawn(test_atom_concat_2/0)
  MACRO_tail(2);
  MACRO_execute(L317, 0);  // execute(test_atom_concat_3/0)
 L308:  // test_atom_concat_1/0
  MACRO_goal(L308, atom(173));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_constant(atom(174),reg::out(1));
  MACRO_out_constant(atom(175),reg::out(2));
  MACRO_out_variable(reg::x(1),reg::out(3));
  MACRO_spawn(L14, L309);  // spawn(atom_concat/3)
 L309:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(176),reg::out(1));
  MACRO_spawn(L110, L310);  // spawn(write/1)
 L310:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_constant(atom(59),reg::out(1));
  MACRO_spawn(L110, L311);  // spawn(write/1)
 L311:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L312);  // spawn(write/1)
 L312:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(60),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L313:  // test_atom_concat_2/0
  MACRO_goal(L313, atom(177));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  ...
  MACRO_spawn(L14, L314);  // spawn(atom_concat/3)
 L314:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(179),reg::out(1));
  MACRO_spawn(L110, L315);  // spawn(write/1)
 L315:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L316);  // spawn(write/1)
 L316:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(180),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L317:  // test_atom_concat_3/0
  MACRO_goal(L317, atom(181));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  ...
  MACRO_out_constant(atom(175),reg::out(2));
  MACRO_out_constant(atom(178),reg::out(3));
  MACRO_spawn(L14, L318);  // spawn(atom_concat/3)
 L318:  // return_from_spawn(atom_concat/3)
  MACRO_par(2);
  MACRO_out_constant(atom(59),reg::out(1));
  MACRO_spawn(L110, L319);  // spawn(write/1)
 L319:  // return_from_spawn(write/1)
  MACRO_par(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L320);  // spawn(write/1)
 L320:  // return_from_spawn(write/1)
  MACRO_tail(2);
  MACRO_out_constant(atom(182),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L321:  // test_atom_chars/0
  MACRO_goal(L321, atom(183));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L323, L322);  // spawn(test_atom_chars1/0)
 L322:  // return_from_spawn(test_atom_chars1/0)
  MACRO_tail(2);
  MACRO_execute(L327, 0);  // execute(test_atom_chars2/0)
 L323:  // test_atom_chars1/0
  MACRO_goal(L323, atom(184));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(2));
  MACRO_get_constant(atom(185),reg::x(2));
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L35, L324);  // spawn(atom_chars/2)
 L324:  // return_from_spawn(atom_chars/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L325);  // spawn(write/1)
 L325:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(186),reg::out(1));
  MACRO_spawn(L110, L326);  // spawn(write/1)
 L326:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L327:  // test_atom_chars2/0
  MACRO_goal(L327, atom(187));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  MACRO_get_list(reg::x(1));
  MACRO_unify_constant(atom(125));
  MACRO_unify_list;
  ...
  MACRO_spawn(L35, L328);  // spawn(atom_chars/2)
 L328:  // return_from_spawn(atom_chars/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L329);  // spawn(write/1)
 L329:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(201),reg::out(1));
  MACRO_spawn(L110, L330);  // spawn(write/1)
 L330:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L331:  // test_atom_codes/0
  MACRO_goal(L331, atom(202));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L333, L332);  // spawn(test_atom_codes1/0)
 L332:  // return_from_spawn(test_atom_codes1/0)
  MACRO_tail(2);
  MACRO_execute(L337, 0);  // execute(test_atom_codes2/0)
 L333:  // test_atom_codes1/0
  MACRO_goal(L333, atom(203));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(2));
  ...
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L26, L334);  // spawn(atom_codes/2)
 L334:  // return_from_spawn(atom_codes/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L335);  // spawn(write/1)
 L335:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(186),reg::out(1));
  MACRO_spawn(L110, L336);  // spawn(write/1)
 L336:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L337:  // test_atom_codes2/0
  MACRO_goal(L337, atom(204));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_spawn(L26, L338);  // spawn(atom_codes/2)
 L338:  // return_from_spawn(atom_codes/2)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L339);  // spawn(write/1)
 L339:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(201),reg::out(1));
  MACRO_spawn(L110, L340);  // spawn(write/1)
 L340:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L341:  // test_append/0
  MACRO_goal(L341, atom(205));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L344, L342);  // spawn(test_append1/0)
 L342:  // return_from_spawn(test_append1/0)
  MACRO_par(2);
  MACRO_spawn(L351, L343);  // spawn(test_append2/0)
 L343:  // return_from_spawn(test_append2/0)
  MACRO_tail(2);
  MACRO_execute(L358, 0);  // execute(test_append3/0)
 L344:  // test_append1/0
  MACRO_goal(L344, atom(206));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L226, L345);  // spawn(append/3)
 L345:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L346);  // spawn(write/1)
 L346:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(207),reg::out(1));
  MACRO_spawn(L110, L347);  // spawn(write/1)
 L347:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L348);  // spawn(write/1)
 L348:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(208),reg::out(1));
  MACRO_spawn(L110, L349);  // spawn(write/1)
 L349:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L110, L350);  // spawn(write/1)
 L350:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_constant(atom(60),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L351:  // test_append2/0
  MACRO_goal(L351, atom(209));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(2));
  ...
  MACRO_spawn(L226, L352);  // spawn(append/3)
 L352:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L353);  // spawn(write/1)
 L353:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(207),reg::out(1));
  MACRO_spawn(L110, L354);  // spawn(write/1)
 L354:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(59),reg::out(1));
  MACRO_spawn(L110, L355);  // spawn(write/1)
 L355:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L110, L356);  // spawn(write/1)
 L356:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(210),reg::out(1));
  MACRO_spawn(L110, L357);  // spawn(write/1)
 L357:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L358:  // test_append3/0
  MACRO_goal(L358, atom(211));
  MACRO_requires(7);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_spawn(L226, L359);  // spawn(append/3)
 L359:  // return_from_spawn(append/3)
  MACRO_par(4);
  MACRO_out_constant(atom(59),reg::out(1));
  MACRO_spawn(L110, L360);  // spawn(write/1)
 L360:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_spawn(L110, L361);  // spawn(write/1)
 L361:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(212),reg::out(1));
  MACRO_spawn(L110, L362);  // spawn(write/1)
 L362:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L363);  // spawn(write/1)
 L363:  // return_from_spawn(write/1)
  MACRO_par(4);
  MACRO_out_constant(atom(213),reg::out(1));
  MACRO_spawn(L110, L364);  // spawn(write/1)
 L364:  // return_from_spawn(write/1)
  MACRO_tail(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L365:  // test_reverse/0
  MACRO_goal(L365, atom(214));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(1),reg::out(2));
  MACRO_spawn(L234, L366);  // spawn(reverse/2)
 L366:  // return_from_spawn(reverse/2)
  MACRO_tail(2);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L367:  // test_nth0/0
  MACRO_goal(L367, atom(215));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L369, L368);  // spawn(test_nth0_/0)
 L368:  // return_from_spawn(test_nth0_/0)
  MACRO_tail(2);
  MACRO_execute(L388, 0);  // execute(test_nth0_rev_/0)
 L369:  // test_nth0_/0
  MACRO_goal(L369, atom(216));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L240, L370);  // spawn(nth0/3)
 L370:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(217),reg::out(1));
  MACRO_spawn(L110, L371);  // spawn(write/1)
 L371:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L372);  // spawn(write/1)
 L372:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(1),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L240, L373);  // spawn(nth0/3)
 L373:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(218),reg::out(1));
  MACRO_spawn(L110, L374);  // spawn(write/1)
 L374:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L375);  // spawn(write/1)
 L375:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L240, L376);  // spawn(nth0/3)
 L376:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(219),reg::out(1));
  MACRO_spawn(L110, L377);  // spawn(write/1)
 L377:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L378);  // spawn(write/1)
 L378:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(3),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L240, L379);  // spawn(nth0/3)
 L379:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(220),reg::out(1));
  MACRO_spawn(L110, L380);  // spawn(write/1)
 L380:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L381);  // spawn(write/1)
 L381:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(4),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L240, L382);  // spawn(nth0/3)
 L382:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(221),reg::out(1));
  MACRO_spawn(L110, L383);  // spawn(write/1)
 L383:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L384);  // spawn(write/1)
 L384:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(5),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(1),reg::out(3));
  MACRO_spawn(L240, L385);  // spawn(nth0/3)
 L385:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(222),reg::out(1));
  MACRO_spawn(L110, L386);  // spawn(write/1)
 L386:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L387);  // spawn(write/1)
 L387:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(60),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L388:  // test_nth0_rev_/0
  MACRO_goal(L388, atom(223));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(125),reg::out(3));
  MACRO_spawn(L240, L389);  // spawn(nth0/3)
 L389:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L390);  // spawn(write/1)
 L390:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L391);  // spawn(write/1)
 L391:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(225),reg::out(1));
  MACRO_spawn(L110, L392);  // spawn(write/1)
 L392:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(126),reg::out(3));
  MACRO_spawn(L240, L393);  // spawn(nth0/3)
 L393:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L394);  // spawn(write/1)
 L394:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L395);  // spawn(write/1)
 L395:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(226),reg::out(1));
  MACRO_spawn(L110, L396);  // spawn(write/1)
 L396:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(127),reg::out(3));
  MACRO_spawn(L240, L397);  // spawn(nth0/3)
 L397:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L398);  // spawn(write/1)
 L398:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L399);  // spawn(write/1)
 L399:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(227),reg::out(1));
  MACRO_spawn(L110, L400);  // spawn(write/1)
 L400:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(188),reg::out(3));
  MACRO_spawn(L240, L401);  // spawn(nth0/3)
 L401:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L402);  // spawn(write/1)
 L402:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L403);  // spawn(write/1)
 L403:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(228),reg::out(1));
  MACRO_spawn(L110, L404);  // spawn(write/1)
 L404:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(189),reg::out(3));
  MACRO_spawn(L240, L405);  // spawn(nth0/3)
 L405:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L406);  // spawn(write/1)
 L406:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L407);  // spawn(write/1)
 L407:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(229),reg::out(1));
  MACRO_spawn(L110, L408);  // spawn(write/1)
 L408:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(190),reg::out(3));
  MACRO_spawn(L240, L409);  // spawn(nth0/3)
 L409:  // return_from_spawn(nth0/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L410);  // spawn(write/1)
 L410:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L411);  // spawn(write/1)
 L411:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(230),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L412:  // test_nth1/0
  MACRO_goal(L412, atom(231));
  MACRO_requires(1);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_spawn(L414, L413);  // spawn(test_nth1_/0)
 L413:  // return_from_spawn(test_nth1_/0)
  MACRO_tail(2);
  MACRO_execute(L430, 0);  // execute(test_nth1_rev_/0)
 L414:  // test_nth1_/0
  MACRO_goal(L414, atom(232));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L250, L415);  // spawn(nth1/3)
 L415:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(233),reg::out(1));
  MACRO_spawn(L110, L416);  // spawn(write/1)
 L416:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L417);  // spawn(write/1)
 L417:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L250, L418);  // spawn(nth1/3)
 L418:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(219),reg::out(1));
  MACRO_spawn(L110, L419);  // spawn(write/1)
 L419:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L420);  // spawn(write/1)
 L420:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(3),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L250, L421);  // spawn(nth1/3)
 L421:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(220),reg::out(1));
  MACRO_spawn(L110, L422);  // spawn(write/1)
 L422:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L423);  // spawn(write/1)
 L423:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(4),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(2),reg::out(3));
  MACRO_spawn(L250, L424);  // spawn(nth1/3)
 L424:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(221),reg::out(1));
  MACRO_spawn(L110, L425);  // spawn(write/1)
 L425:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L426);  // spawn(write/1)
 L426:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(tagvalue<TAG_INT>(5),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_variable(reg::x(1),reg::out(3));
  MACRO_spawn(L250, L427);  // spawn(nth1/3)
 L427:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(222),reg::out(1));
  MACRO_spawn(L110, L428);  // spawn(write/1)
 L428:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_spawn(L110, L429);  // spawn(write/1)
 L429:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(60),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L430:  // test_nth1_rev_/0
  MACRO_goal(L430, atom(234));
  MACRO_requires(6);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_set_variable(reg::x(1));
  ...
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(125),reg::out(3));
  MACRO_spawn(L250, L431);  // spawn(nth1/3)
 L431:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L432);  // spawn(write/1)
 L432:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L433);  // spawn(write/1)
 L433:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(225),reg::out(1));
  MACRO_spawn(L110, L434);  // spawn(write/1)
 L434:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(126),reg::out(3));
  MACRO_spawn(L250, L435);  // spawn(nth1/3)
 L435:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L436);  // spawn(write/1)
 L436:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L437);  // spawn(write/1)
 L437:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(226),reg::out(1));
  MACRO_spawn(L110, L438);  // spawn(write/1)
 L438:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(127),reg::out(3));
  MACRO_spawn(L250, L439);  // spawn(nth1/3)
 L439:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L440);  // spawn(write/1)
 L440:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L441);  // spawn(write/1)
 L441:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(227),reg::out(1));
  MACRO_spawn(L110, L442);  // spawn(write/1)
 L442:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(188),reg::out(3));
  MACRO_spawn(L250, L443);  // spawn(nth1/3)
 L443:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L444);  // spawn(write/1)
 L444:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L445);  // spawn(write/1)
 L445:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_constant(atom(228),reg::out(1));
  MACRO_spawn(L110, L446);  // spawn(write/1)
 L446:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(1),reg::out(2));
  MACRO_out_constant(atom(189),reg::out(3));
  MACRO_spawn(L250, L447);  // spawn(nth1/3)
 L447:  // return_from_spawn(nth1/3)
  MACRO_par(3);
  MACRO_out_constant(atom(224),reg::out(1));
  MACRO_spawn(L110, L448);  // spawn(write/1)
 L448:  // return_from_spawn(write/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_spawn(L110, L449);  // spawn(write/1)
 L449:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_constant(atom(229),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L450:  // test_splice_suspension/0
  MACRO_goal(L450, atom(235));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_spawn(L455, L451);  // spawn(test_splice_suspension1/1)
 L451:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L455, L452);  // spawn(test_splice_suspension1/1)
 L452:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_par(4);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_spawn(L455, L453);  // spawn(test_splice_suspension1/1)
 L453:  // return_from_spawn(test_splice_suspension1/1)
  MACRO_get_value(reg::x(2),reg::x(1));
  MACRO_get_value(reg::x(3),reg::x(2));
  MACRO_par(4);
  MACRO_out_constant(atom(236),reg::out(1));
  MACRO_spawn(L260, L454);  // spawn(dump_to_dot/1)
 L454:  // return_from_spawn(dump_to_dot/1)
  MACRO_get_constant(atom(235),reg::x(1));
  MACRO_proceed;
 L455:  // test_splice_suspension1/1
  MACRO_goal(L455, atom(237));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_wait(reg::in(1));
  MACRO_activate;
  ...
  MACRO_execute(L102, 1);  // execute(writeln/1)
 L456:  // test_calc/0
  MACRO_goal(L456, atom(238));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(2);
  MACRO_out_constant(atom(239),reg::out(1));
  MACRO_spawn(L102, L457);  // spawn(writeln/1)
 L457:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(2),reg::out(2));
  MACRO_call(L220, L458);  // call(__dec__/2)
 L458:  // return_from_call(__dec__/2)
  MACRO_par(3);
  MACRO_out_constant(atom(240),reg::out(1));
  MACRO_spawn(L102, L459);  // spawn(writeln/1)
 L459:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_structure(atom(85),reg::out(1));
  MACRO_write_value(reg::x(2));
  MACRO_write_structure(atom(87));
  MACRO_write_value(reg::x(1));
  MACRO_write_constant(tagvalue<TAG_INT>(1));
  MACRO_spawn(L102, L460);  // spawn(writeln/1)
 L460:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_value(reg::x(1),reg::out(1));
  MACRO_out_variable(reg::x(2),reg::out(2));
  MACRO_call(L216, L461);  // call(__inc__/2)
 L461:  // return_from_call(__inc__/2)
  MACRO_par(3);
  MACRO_out_structure(atom(85),reg::out(1));
  MACRO_write_value(reg::x(2));
  MACRO_write_structure(atom(86));
  MACRO_write_value(reg::x(1));
  MACRO_write_constant(tagvalue<TAG_INT>(1));
  MACRO_spawn(L102, L462);  // spawn(writeln/1)
 L462:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_constant(atom(241),reg::out(1));
  MACRO_spawn(L102, L463);  // spawn(writeln/1)
 L463:  // return_from_spawn(writeln/1)
  MACRO_par(3);
  MACRO_out_constant(atom(242),reg::out(1));
  MACRO_spawn(L260, L464);  // spawn(dump_to_dot/1)
 L464:  // return_from_spawn(dump_to_dot/1)
  MACRO_get_constant(tagvalue<TAG_INT>(10),reg::x(1));
  MACRO_proceed;
 L465:  // do_test/1
  MACRO_goal(L465, atom(243));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_seq(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_call(L110, L466);  // call(write/1)
 L466:  // return_from_call(write/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(244),reg::out(1));
  MACRO_call(L102, L467);  // call(writeln/1)
 L467:  // return_from_call(writeln/1)
  MACRO_tail(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_execute(L6, 1);  // execute(time/1)
 L468:  // main/1
  MACRO_goal(L468, atom(245));
  MACRO_requires(4);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_seq(3);
  MACRO_out_constant(atom(123),reg::out(1));
  MACRO_call(L465, L469);  // call(do_test/1)
 L469:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(131),reg::out(1));
  MACRO_call(L465, L470);  // call(do_test/1)
 L470:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(135),reg::out(1));
  MACRO_call(L465, L471);  // call(do_test/1)
 L471:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(136),reg::out(1));
  MACRO_call(L465, L472);  // call(do_test/1)
 L472:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(138),reg::out(1));
  MACRO_call(L465, L473);  // call(do_test/1)
 L473:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(139),reg::out(1));
  MACRO_call(L465, L474);  // call(do_test/1)
 L474:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(144),reg::out(1));
  MACRO_call(L465, L475);  // call(do_test/1)
 L475:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(145),reg::out(1));
  MACRO_call(L465, L476);  // call(do_test/1)
 L476:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(146),reg::out(1));
  MACRO_call(L465, L477);  // call(do_test/1)
 L477:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(147),reg::out(1));
  MACRO_call(L465, L478);  // call(do_test/1)
 L478:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(148),reg::out(1));
  MACRO_call(L465, L479);  // call(do_test/1)
 L479:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(153),reg::out(1));
  MACRO_call(L465, L480);  // call(do_test/1)
 L480:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(159),reg::out(1));
  MACRO_call(L465, L481);  // call(do_test/1)
 L481:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(163),reg::out(1));
  MACRO_call(L465, L482);  // call(do_test/1)
 L482:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(168),reg::out(1));
  MACRO_call(L465, L483);  // call(do_test/1)
 L483:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(172),reg::out(1));
  MACRO_call(L465, L484);  // call(do_test/1)
 L484:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(183),reg::out(1));
  MACRO_call(L465, L485);  // call(do_test/1)
 L485:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(202),reg::out(1));
  MACRO_call(L465, L486);  // call(do_test/1)
 L486:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(205),reg::out(1));
  MACRO_call(L465, L487);  // call(do_test/1)
 L487:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(214),reg::out(1));
  MACRO_call(L465, L488);  // call(do_test/1)
 L488:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(215),reg::out(1));
  MACRO_call(L465, L489);  // call(do_test/1)
 L489:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(231),reg::out(1));
  MACRO_call(L465, L490);  // call(do_test/1)
 L490:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(235),reg::out(1));
  MACRO_call(L465, L491);  // call(do_test/1)
 L491:  // return_from_call(do_test/1)
  MACRO_seq(3);
  MACRO_out_constant(atom(238),reg::out(1));
  MACRO_call(L465, L492);  // call(do_test/1)
 L492:  // return_from_call(do_test/1)
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L256, L493);  // spawn(inference_count/1)
 L493:  // return_from_spawn(inference_count/1)
  MACRO_par(3);
  MACRO_out_constant(atom(246),reg::out(1));
  MACRO_spawn(L110, L494);  // spawn(write/1)
 L494:  // return_from_spawn(write/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L102, 1);  // execute(writeln/1)
 LNO_MORE_GOALS:

...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(123) = to_atom("primes", 2);
    atom(124) = to_atom("gen", 3);
    atom(125) = to_atom("sift", 2);
    atom(126) = to_atom("filter", 3);
    ...
    prog->add_entry_point(atom(123), &&L266);  // primes / 2
    prog->add_entry_point(atom(124), &&L268);  // gen / 3
    prog->add_entry_point(atom(125), &&L273);  // sift / 2
    prog->add_entry_point(atom(126), &&L276);  // filter / 3
    prog->add_entry_point(atom(127), &&L283);  // printstream / 1
    prog->add_entry_point(atom(128), &&L285);  // printstream / 2
    prog->add_entry_point(atom(129), &&L287);  // printstream_rest / 2
    prog->add_entry_point(atom(130), &&L289);  // main / 1
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
 ...
 L266:  // primes/2
  ...
  MACRO_spawn(L268, L267);  // spawn(gen/3)
 L267:  // return_from_spawn(gen/3)
  MACRO_tail(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_execute(L273, 2);  // execute(sift/2)
 L268:  // gen/3
  MACRO_goal(L268, atom(124));
  MACRO_requires(9);
  MACRO_try_guard_else(L271);
  MACRO_seq(5);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_call(L158, L269);  // call((=<)/2)
 L269:  // return_from_call((=<)/2)
  MACRO_activate;
  MACRO_par(5);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(4),reg::out(2));
  MACRO_call(L216, L270);  // call(__inc__/2)
 L270:  // return_from_call(__inc__/2)
  MACRO_get_list(reg::in(3));
  ...
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_out_value(reg::x(5),reg::out(3));
  MACRO_execute(L268, 3);  // execute(gen/3)
 L271:  // gen/3-2
  MACRO_try_guard_else_suspend;
  MACRO_seq(6);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_call(L159, L272);  // call((>)/2)
 L272:  // return_from_call((>)/2)
  MACRO_activate;
  MACRO_get_nil(reg::in(3));
  MACRO_proceed;
 L273:  // sift/2
  MACRO_goal(L273, atom(125));
  MACRO_requires(9);
  ...
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_out_variable(reg::x(3),reg::out(3));
  MACRO_spawn(L276, L274);  // spawn(filter/3)
 L274:  // return_from_spawn(filter/3)
  MACRO_tail(6);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_value(reg::x(5),reg::out(2));
  MACRO_execute(L273, 2);  // execute(sift/2)
 ...
 L276:  // filter/3
  ...
  MACRO_call(L168, L277);  // call((:=)/2)
 L277:  // return_from_call((:=)/2)
  MACRO_seq(7);
  MACRO_out_structure(atom(90),reg::out(1));
  MACRO_write_value(reg::x(5));
  MACRO_write_value(reg::in(1));
  MACRO_out_value(reg::x(6),reg::out(2));
  MACRO_call(L164, L278);  // call((=\=)/2)
 L278:  // return_from_call((=\=)/2)
  ...
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_out_value(reg::x(5),reg::out(3));
  MACRO_execute(L276, 3);  // execute(filter/3)
 L279:  // filter/3-2
 ...
 L280:  // return_from_call((:=)/2)
  ...
  MACRO_write_value(reg::in(1));
  MACRO_out_value(reg::x(6),reg::out(2));
  MACRO_call(L161, L281);  // call((=:=)/2)
 L281:  // return_from_call((=:=)/2)
  MACRO_activate;
  MACRO_tail(7);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::x(4),reg::out(2));
 ...
 L282:  // filter/3-3
  ...
  MACRO_proceed;
 L283:  // printstream/1
  MACRO_goal(L283, atom(127));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L48, L284);  // spawn(outstream/1)
 L284:  // return_from_spawn(outstream/1)
  MACRO_tail(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_execute(L285, 2);  // execute(printstream/2)
 L285:  // printstream/2
  MACRO_goal(L285, atom(128));
  MACRO_requires(7);
 ...
 L286:  // printstream/2-2
  ...
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_execute(L287, 2);  // execute(printstream_rest/2)
 L287:  // printstream_rest/2
  MACRO_goal(L287, atom(129));
  MACRO_requires(7);
 ...
 L289:  // main/1
  ...
  MACRO_spawn(L42, L290);  // spawn(atom_number/2)
 L290:  // return_from_spawn(atom_number/2)
  MACRO_par(3);
  MACRO_out_structure(atom(123),reg::out(1));
  MACRO_write_value(reg::x(2));
  MACRO_write_variable(reg::x(2));
  MACRO_spawn(L6, L291);  // spawn(time/1)
 L291:  // return_from_spawn(time/1)
  MACRO_tail(3);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_execute(L283, 1);  // execute(printstream/1)
 L292:  // main/1-2
  MACRO_otherwise;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(2));

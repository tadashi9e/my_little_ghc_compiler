      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 266:  // primes/2
      ...
      MACRO_spawn(268,267);  // spawn(gen/3)
    case 267:  // return_from_spawn(gen/3)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_execute(273,2);  // execute(sift/2)
    case 268:  // gen/3
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(158,269);  // call((=<)/2)
    case 269:  // return_from_call((=<)/2)
      MACRO_activate;
      MACRO_par(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_call(216,270);  // call(__inc__/2)
    case 270:  // return_from_call(__inc__/2)
      MACRO_get_list(reg::in(3));
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(268,3);  // execute(gen/3)
    case 271:  // gen/3-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(6);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(159,272);  // call((>)/2)
    case 272:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_get_nil(reg::in(3));
      MACRO_proceed;
    case 273:  // sift/2
      MACRO_goal(273,atom(125));
      MACRO_requires(9);
      ...
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_variable(reg::x(3),reg::out(3));
      MACRO_spawn(276,274);  // spawn(filter/3)
    case 274:  // return_from_spawn(filter/3)
      MACRO_tail(6);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(5),reg::out(2));
      MACRO_execute(273,2);  // execute(sift/2)
    ...
    case 278:  // return_from_call((=\=)/2)
      ...
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(276,3);  // execute(filter/3)
    case 279:  // filter/3-2
    ...
    case 282:  // filter/3-3
      ...
      MACRO_get_nil(reg::in(3));
      MACRO_proceed;
    case 283:  // printstream/1
      MACRO_goal(283,atom(127));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(48,284);  // spawn(outstream/1)
    case 284:  // return_from_spawn(outstream/1)
      MACRO_tail(3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(285,2);  // execute(printstream/2)
    case 285:  // printstream/2
      MACRO_goal(285,atom(128));
      MACRO_requires(7);
    ...
    case 286:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(287,2);  // execute(printstream_rest/2)
    case 287:  // printstream_rest/2
    ...
    case 289:  // main/1
      ...
      MACRO_spawn(42,290);  // spawn(atom_number/2)
    case 290:  // return_from_spawn(atom_number/2)
      ...
      MACRO_spawn(4,291);  // spawn(time/1)
    case 291:  // return_from_spawn(time/1)
      MACRO_tail(3);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_execute(283,1);  // execute(printstream/1)
    case 292:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(123), 266);  // primes / 2
  prog->add_entry_point(atom(124), 268);  // gen / 3
  prog->add_entry_point(atom(125), 273);  // sift / 2
  prog->add_entry_point(atom(126), 276);  // filter / 3
  prog->add_entry_point(atom(127), 283);  // printstream / 1
  prog->add_entry_point(atom(128), 285);  // printstream / 2
  prog->add_entry_point(atom(129), 287);  // printstream_rest / 2

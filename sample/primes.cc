...
Q atom(119);  // sift / 2
Q atom(120);  // filter / 3
Q atom(121);  // printstream / 1
Q atom(122);  // printstream / 2
Q atom(123);  // printstream_rest / 2
Q atom(124);  // main / 1
Q atom(125);  // usage:  / 0
Q atom(126);  //  <max> / 0
      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 254:  // primes/2
      ...
      MACRO_spawn(256,255);  // spawn(gen/3)
    case 255:  // return_from_spawn(gen/3)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_execute(261,2);  // execute(sift/2)
    case 256:  // gen/3
      MACRO_goal(256,atom(118));
      MACRO_requires(10);
      MACRO_try_guard_else(259);
      MACRO_seq(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(156,257);  // call((=<)/2)
    case 257:  // return_from_call((=<)/2)
      MACRO_activate;
      MACRO_par(5);
      MACRO_out_variable(reg::x(4),reg::out(1));
      MACRO_out_structure(atom(38),reg::out(2));
      MACRO_write_value(reg::in(1));
      MACRO_write_constant(tagvalue<TAG_INT>(1));
      MACRO_spawn(166,258);  // spawn((:=)/2)
    case 258:  // return_from_spawn((:=)/2)
      MACRO_get_list(reg::in(3));
      MACRO_unify_value(reg::in(1));
      MACRO_unify_variable(reg::x(6));
      MACRO_tail(7);
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(6),reg::out(3));
      MACRO_execute(256,3);  // execute(gen/3)
    case 259:  // gen/3-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(7);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(157,260);  // call((>)/2)
    case 260:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_get_nil(reg::in(3));
      MACRO_proceed;
    case 261:  // sift/2
      MACRO_goal(261,atom(119));
      MACRO_requires(13);
      MACRO_try_guard_else(263);
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(3));
      MACRO_read_variable(reg::x(5));
      MACRO_activate;
      ...
      MACRO_unify_variable(reg::x(7));
      MACRO_par(10);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(5),reg::out(2));
      MACRO_out_variable(reg::x(9),reg::out(3));
      MACRO_spawn(264,262);  // spawn(filter/3)
    case 262:  // return_from_spawn(filter/3)
      MACRO_tail(10);
      MACRO_out_value(reg::x(9),reg::out(1));
      MACRO_out_value(reg::x(7),reg::out(2));
      MACRO_execute(261,2);  // execute(sift/2)
    case 263:  // sift/2-2
      ...
      MACRO_proceed;
    case 264:  // filter/3
      MACRO_goal(264,atom(120));
      MACRO_requires(16);
      MACRO_try_guard_else(266);
      MACRO_check_list(reg::in(2));
      MACRO_read_variable(reg::x(4));
      MACRO_read_variable(reg::x(6));
      MACRO_seq(7);
      MACRO_out_structure(atom(88),reg::out(1));
      MACRO_write_value(reg::x(4));
      MACRO_write_value(reg::in(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(162,265);  // call((=\=)/2)
    case 265:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_get_list(reg::in(3));
      MACRO_unify_value(reg::x(4));
      ...
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_out_value(reg::x(8),reg::out(3));
      MACRO_execute(264,3);  // execute(filter/3)
    case 266:  // filter/3-2
      ...
      MACRO_write_value(reg::in(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(159,267);  // call((=:=)/2)
    case 267:  // return_from_call((=:=)/2)
      MACRO_activate;
      MACRO_tail(13);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(12),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_execute(264,3);  // execute(filter/3)
    case 268:  // filter/3-3
      MACRO_try_guard_else_suspend;
      ...
      MACRO_get_nil(reg::in(3));
      MACRO_proceed;
    case 269:  // printstream/1
      MACRO_goal(269,atom(121));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(46,270);  // spawn(outstream/1)
    case 270:  // return_from_spawn(outstream/1)
      MACRO_tail(3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(271,2);  // execute(printstream/2)
    case 271:  // printstream/2
      MACRO_goal(271,atom(122));
      MACRO_requires(10);
    ...
    case 272:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(7),reg::out(2));
      MACRO_execute(273,2);  // execute(printstream_rest/2)
    case 273:  // printstream_rest/2
      MACRO_goal(273,atom(123));
      MACRO_requires(10);
      MACRO_try_guard_else(274);
      MACRO_check_nil(reg::in(1));
      MACRO_activate;
      MACRO_get_list(reg::in(2));
    ...
    case 275:  // main/1
      ...
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_spawn(40,276);  // spawn(atom_number/2)
    case 276:  // return_from_spawn(atom_number/2)
      MACRO_par(7);
      MACRO_out_structure(atom(117),reg::out(1));
      MACRO_write_value(reg::x(4));
      MACRO_write_variable(reg::x(6));
      MACRO_spawn(4,277);  // spawn(time/1)
    case 277:  // return_from_spawn(time/1)
      MACRO_tail(7);
      MACRO_out_value(reg::x(6),reg::out(1));
      MACRO_execute(269,1);  // execute(printstream/1)
    case 278:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(8));
...
void setup(Program* prog) {
  ...
  atom(117) = to_atom("primes", 2);
  atom(118) = to_atom("gen", 3);
  atom(119) = to_atom("sift", 2);
  atom(120) = to_atom("filter", 3);
  atom(121) = to_atom("printstream", 1);
  atom(122) = to_atom("printstream", 2);
  atom(123) = to_atom("printstream_rest", 2);
  atom(124) = to_atom("main", 1);
  atom(125) = to_atom("usage: ", 0);
  atom(126) = to_atom(" <max>", 0);
  // setup entry points
  ...
  prog->add_entry_point(atom(117), 254);  // primes / 2
  prog->add_entry_point(atom(118), 256);  // gen / 3
  prog->add_entry_point(atom(119), 261);  // sift / 2
  prog->add_entry_point(atom(120), 264);  // filter / 3
  prog->add_entry_point(atom(121), 269);  // printstream / 1
  prog->add_entry_point(atom(122), 271);  // printstream / 2
  prog->add_entry_point(atom(123), 273);  // printstream_rest / 2
  prog->add_entry_point(atom(124), 275);  // main / 1
}
int

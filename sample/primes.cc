      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 264:  // primes/2
      ...
      MACRO_spawn(266,265);  // spawn(gen/3)
    case 265:  // return_from_spawn(gen/3)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_execute(271,2);  // execute(sift/2)
    case 266:  // gen/3
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(156,267);  // call((=<)/2)
    case 267:  // return_from_call((=<)/2)
      MACRO_activate;
      MACRO_par(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_call(214,268);  // call(__inc__/2)
    case 268:  // return_from_call(__inc__/2)
      MACRO_get_list(reg::in(3));
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(266,3);  // execute(gen/3)
    case 269:  // gen/3-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(6);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(157,270);  // call((>)/2)
    case 270:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_get_nil(reg::in(3));
      MACRO_proceed;
    case 271:  // sift/2
      MACRO_goal(271,atom(123));
      MACRO_requires(9);
      ...
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_variable(reg::x(3),reg::out(3));
      MACRO_spawn(274,272);  // spawn(filter/3)
    case 272:  // return_from_spawn(filter/3)
      MACRO_tail(6);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(5),reg::out(2));
      MACRO_execute(271,2);  // execute(sift/2)
    ...
    case 276:  // return_from_call((=\=)/2)
      ...
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(274,3);  // execute(filter/3)
    case 277:  // filter/3-2
    ...
    case 281:  // printstream/1
      MACRO_goal(281,atom(125));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(46,282);  // spawn(outstream/1)
    ...
    case 287:  // main/1
      ...
      MACRO_spawn(40,288);  // spawn(atom_number/2)
    case 288:  // return_from_spawn(atom_number/2)
      MACRO_par(3);
      MACRO_out_structure(atom(121),reg::out(1));
      MACRO_write_value(reg::x(2));
      MACRO_write_variable(reg::x(2));
      MACRO_spawn(4,289);  // spawn(time/1)
    case 289:  // return_from_spawn(time/1)
      MACRO_tail(3);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_execute(281,1);  // execute(printstream/1)
    case 290:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(121), 264);  // primes / 2
  prog->add_entry_point(atom(122), 266);  // gen / 3
  prog->add_entry_point(atom(123), 271);  // sift / 2
  prog->add_entry_point(atom(124), 274);  // filter / 3
  prog->add_entry_point(atom(125), 281);  // printstream / 1
  prog->add_entry_point(atom(126), 283);  // printstream / 2
  prog->add_entry_point(atom(127), 285);  // printstream_rest / 2
  prog->add_entry_point(atom(128), 287);  // main / 1
}
int

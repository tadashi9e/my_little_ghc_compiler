      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 269:  // fibonacci/2
      ...
      MACRO_execute(270,4);  // execute(fib/4)
    case 270:  // fib/4
      ...
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_value(reg::in(1),reg::out(2));
      MACRO_call(165,271,atom(84));  // call((=<)/2)
    case 271:  // return_from_call((=<)/2)
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(5),reg::out(3));
      MACRO_spawn(179,272,atom(45));  // spawn(__add__/3)
    case 272:  // return_from_spawn(__add__/3)
      MACRO_tail(4,7);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_value(reg::y(5),reg::out(3));
    ...
    case 273:  // fib/4-2
      ...
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_value(reg::in(1),reg::out(2));
      MACRO_call(166,274,atom(85));  // call((>)/2)
    case 274:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_get_nil(reg::in(4));
      MACRO_proceed;
    case 275:  // printstream/1
      ...
      MACRO_par(1,3);
      MACRO_out_variable(reg::y(2),reg::out(1));
      MACRO_spawn(54,276,atom(29));  // spawn(outstream/1)
    case 276:  // return_from_spawn(outstream/1)
      MACRO_tail(2,3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::y(2),reg::out(2));
      MACRO_execute(277,2);  // execute(printstream/2)
    case 277:  // printstream/2
      MACRO_goal(277,atom(129));
      MACRO_requires(7);
    ...
    case 278:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(279,2);  // execute(printstream_rest/2)
    case 279:  // printstream_rest/2
    ...
    case 282:  // return_from_spawn(atom_number/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(275,283,atom(128));  // spawn(printstream/1)
    case 283:  // return_from_spawn(printstream/1)
      MACRO_tail(2,4);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_execute(269,2);  // execute(fibonacci/2)
    case 284:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(4));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(126), 269);  // fibonacci / 2
  prog->add_entry_point(atom(127), 270);  // fib / 4
  prog->add_entry_point(atom(128), 275);  // printstream / 1
  prog->add_entry_point(atom(129), 277);  // printstream / 2
  prog->add_entry_point(atom(130), 279);  // printstream_rest / 2
  prog->add_entry_point(atom(131), 281);  // main / 1
}
int

      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 266:  // fibonacci/2
      ...
      MACRO_execute(267,4);  // execute(fib/4)
    case 267:  // fib/4
    ...
    case 268:  // return_from_call((=<)/2)
      ...
      MACRO_call(176,269);  // call(__add__/3)
    case 269:  // return_from_call(__add__/3)
      MACRO_tail(7);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
    ...
    case 272:  // printstream/1
      ...
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(48,273);  // spawn(outstream/1)
    case 273:  // return_from_spawn(outstream/1)
      MACRO_tail(3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(274,2);  // execute(printstream/2)
    case 274:  // printstream/2
    ...
    case 275:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(276,2);  // execute(printstream_rest/2)
    case 276:  // printstream_rest/2
    ...
    case 278:  // main/1
      ...
      MACRO_spawn(42,279);  // spawn(atom_number/2)
    case 279:  // return_from_spawn(atom_number/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(272,280);  // spawn(printstream/1)
    case 280:  // return_from_spawn(printstream/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(266,2);  // execute(fibonacci/2)
    case 281:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  atom(123) = to_atom("fibonacci", 2);
  atom(124) = to_atom("fib", 4);
  ...
  prog->add_entry_point(atom(123), 266);  // fibonacci / 2
  prog->add_entry_point(atom(124), 267);  // fib / 4
  prog->add_entry_point(atom(125), 272);  // printstream / 1
  prog->add_entry_point(atom(126), 274);  // printstream / 2
  prog->add_entry_point(atom(127), 276);  // printstream_rest / 2
  prog->add_entry_point(atom(128), 278);  // main / 1
}
int

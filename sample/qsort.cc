      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 268:  // qsort/2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_nil(reg::out(3));
      MACRO_execute(269,3);  // execute(qsort/3)
    case 269:  // qsort/3
      ...
      MACRO_spawn(273,270);  // spawn(part/4)
    case 270:  // return_from_spawn(part/4)
      MACRO_par(7);
      MACRO_out_value(reg::x(6),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_write_value(reg::x(4));
      MACRO_write_variable(reg::x(4));
      MACRO_spawn(269,271);  // spawn(qsort/3)
    case 271:  // return_from_spawn(qsort/3)
      MACRO_tail(7);
      MACRO_out_value(reg::x(5),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 274:  // return_from_call((<)/2)
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::x(6),reg::out(4));
      MACRO_execute(273,4);  // execute(part/4)
    case 275:  // part/4-2
    ...
    case 279:  // atom_number_list/2-2
      ...
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_spawn(44,280);  // spawn(atom_number/2)
    case 280:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(278,2);  // execute(atom_number_list/2)
    case 281:  // printstream/1
      ...
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(50,282);  // spawn(outstream/1)
    case 282:  // return_from_spawn(outstream/1)
      MACRO_tail(3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(283,2);  // execute(printstream/2)
    case 283:  // printstream/2
    ...
    case 284:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(285,2);  // execute(printstream_rest/2)
    case 285:  // printstream_rest/2
    ...
    case 287:  // main/1
      ...
      MACRO_spawn(278,288);  // spawn(atom_number_list/2)
    case 288:  // return_from_spawn(atom_number_list/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(281,289);  // spawn(printstream/1)
    case 289:  // return_from_spawn(printstream/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(268,2);  // execute(qsort/2)
    case 290:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  atom(125) = to_atom("qsort", 2);
  atom(126) = to_atom("qsort", 3);
  atom(127) = to_atom("part", 4);
  atom(128) = to_atom("atom_number_list", 2);
  ...
  prog->add_entry_point(atom(125), 268);  // qsort / 2
  prog->add_entry_point(atom(126), 269);  // qsort / 3
  prog->add_entry_point(atom(127), 273);  // part / 4
  prog->add_entry_point(atom(128), 278);  // atom_number_list / 2
  prog->add_entry_point(atom(129), 281);  // printstream / 1
  prog->add_entry_point(atom(130), 283);  // printstream / 2
  prog->add_entry_point(atom(131), 285);  // printstream_rest / 2
  prog->add_entry_point(atom(132), 287);  // main / 1
}
int

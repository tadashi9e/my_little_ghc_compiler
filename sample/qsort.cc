...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(121) = to_atom("qsort", 2);
    atom(122) = to_atom("qsort", 3);
    atom(123) = to_atom("part", 4);
    atom(124) = to_atom("atom_number_list", 2);
    ...
    prog->add_entry_point(atom(121), &&L264);  // qsort / 2
    prog->add_entry_point(atom(122), &&L265);  // qsort / 3
    prog->add_entry_point(atom(123), &&L269);  // part / 4
    prog->add_entry_point(atom(124), &&L274);  // atom_number_list / 2
    prog->add_entry_point(atom(125), &&L277);  // printstream / 1
    prog->add_entry_point(atom(126), &&L279);  // printstream / 2
    prog->add_entry_point(atom(127), &&L281);  // printstream_rest / 2
    prog->add_entry_point(atom(128), &&L283);  // main / 1
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
    vm->FAIL3 = &&LFAIL3;
 ...
 L264:  // qsort/2
  ...
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_out_nil(reg::out(3));
  MACRO_execute(L265, 3);  // execute(qsort/3)
 L265:  // qsort/3
  ...
  MACRO_spawn(L269, L266);  // spawn(part/4)
 L266:  // return_from_spawn(part/4)
  MACRO_par(7);
  MACRO_out_value(reg::x(6),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  ...
  MACRO_write_value(reg::x(4));
  MACRO_write_variable(reg::x(4));
  MACRO_spawn(L265, L267);  // spawn(qsort/3)
 L267:  // return_from_spawn(qsort/3)
  MACRO_tail(7);
  MACRO_out_value(reg::x(5),reg::out(1));
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_out_value(reg::in(3),reg::out(3));
 ...
 L268:  // qsort/3-2
  ...
  MACRO_proceed;
 L269:  // part/4
  MACRO_goal(L269, atom(123));
  MACRO_requires(11);
  MACRO_try_guard_else(L271);
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(6));
  MACRO_read_variable(reg::x(5));
  MACRO_seq(7);
 ...
 L270:  // return_from_call((<)/2)
  ...
  MACRO_out_value(reg::in(3),reg::out(3));
  MACRO_out_value(reg::x(6),reg::out(4));
  MACRO_execute(L269, 4);  // execute(part/4)
 L271:  // part/4-2
  ...
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(6),reg::out(2));
  MACRO_call(L155, L272);  // call((>=)/2)
 L272:  // return_from_call((>=)/2)
  MACRO_activate;
  MACRO_get_list(reg::in(3));
  MACRO_unify_value(reg::x(6));
  MACRO_unify_variable(reg::x(6));
 ...
 L273:  // part/4-3
  ...
  MACRO_proceed;
 L274:  // atom_number_list/2
  MACRO_goal(L274, atom(124));
  MACRO_requires(7);
  MACRO_try_guard_else(L275);
  MACRO_check_nil(reg::in(1));
  MACRO_activate;
  MACRO_get_nil(reg::in(2));
  MACRO_proceed;
 L275:  // atom_number_list/2-2
  MACRO_try_guard_else_suspend;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(4));
  MACRO_read_variable(reg::x(3));
  ...
  MACRO_out_value(reg::x(4),reg::out(1));
  MACRO_out_variable(reg::x(4),reg::out(2));
  MACRO_spawn(L40, L276);  // spawn(atom_number/2)
 L276:  // return_from_spawn(atom_number/2)
  ...
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_execute(L274, 2);  // execute(atom_number_list/2)
 L277:  // printstream/1
  MACRO_goal(L277, atom(125));
  MACRO_requires(5);
  MACRO_try_guard_else_suspend;
  MACRO_activate;
  MACRO_par(3);
  MACRO_out_variable(reg::x(2),reg::out(1));
  MACRO_spawn(L46, L278);  // spawn(outstream/1)
 L278:  // return_from_spawn(outstream/1)
  MACRO_tail(3);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_execute(L279, 2);  // execute(printstream/2)
 L279:  // printstream/2
  MACRO_goal(L279, atom(126));
  MACRO_requires(7);
 ...
 L280:  // printstream/2-2
  ...
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_value(reg::x(4),reg::out(2));
  MACRO_execute(L281, 2);  // execute(printstream_rest/2)
 L281:  // printstream_rest/2
  MACRO_goal(L281, atom(127));
  MACRO_requires(7);
 ...
 L283:  // main/1
  ...
  MACRO_spawn(L274, L284);  // spawn(atom_number_list/2)
 L284:  // return_from_spawn(atom_number_list/2)
  MACRO_par(4);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_spawn(L277, L285);  // spawn(printstream/1)
 L285:  // return_from_spawn(printstream/1)
  MACRO_tail(4);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_execute(L264, 2);  // execute(qsort/2)
 L286:  // main/1-2
  MACRO_otherwise;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(2));

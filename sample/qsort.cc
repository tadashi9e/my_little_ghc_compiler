      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 269:  // qsort/2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_nil(reg::out(3));
      MACRO_execute(270,3);  // execute(qsort/3)
    case 270:  // qsort/3
      ...
      MACRO_spawn(274,271,atom(128));  // spawn(part/4)
    case 271:  // return_from_spawn(part/4)
      MACRO_par(3,7);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_spawn(270,272,atom(127));  // spawn(qsort/3)
    case 272:  // return_from_spawn(qsort/3)
      MACRO_tail(3,7);
      MACRO_out_value(reg::y(5),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 274:  // part/4
      ...
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_call(167,275,atom(86));  // call((<)/2)
    case 275:  // return_from_call((<)/2)
      ...
      MACRO_execute(274,4);  // execute(part/4)
    case 276:  // part/4-2
      ...
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_call(164,277,atom(83));  // call((>=)/2)
    ...
    case 280:  // atom_number_list/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(48,281,atom(26));  // spawn(atom_number/2)
    case 281:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(5),reg::out(2));
      MACRO_execute(279,2);  // execute(atom_number_list/2)
    case 282:  // printstream/1
      MACRO_goal(282,atom(130));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(1,3);
      MACRO_out_variable(reg::y(2),reg::out(1));
      MACRO_spawn(54,283,atom(29));  // spawn(outstream/1)
    case 283:  // return_from_spawn(outstream/1)
      MACRO_tail(2,3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::y(2),reg::out(2));
      MACRO_execute(284,2);  // execute(printstream/2)
    case 284:  // printstream/2
      MACRO_goal(284,atom(131));
      MACRO_requires(7);
    ...
    case 285:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(286,2);  // execute(printstream_rest/2)
    case 286:  // printstream_rest/2
      MACRO_goal(286,atom(132));
      MACRO_requires(7);
    ...
    case 288:  // main/1
      ...
      MACRO_spawn(279,289,atom(129));  // spawn(atom_number_list/2)
    case 289:  // return_from_spawn(atom_number_list/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(282,290,atom(130));  // spawn(printstream/1)
    case 290:  // return_from_spawn(printstream/1)
      MACRO_tail(2,4);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_execute(269,2);  // execute(qsort/2)
    case 291:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(4));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(126), 269);  // qsort / 2
  prog->add_entry_point(atom(127), 270);  // qsort / 3
  prog->add_entry_point(atom(128), 274);  // part / 4
  prog->add_entry_point(atom(129), 279);  // atom_number_list / 2
  prog->add_entry_point(atom(130), 282);  // printstream / 1
  prog->add_entry_point(atom(131), 284);  // printstream / 2
  prog->add_entry_point(atom(132), 286);  // printstream_rest / 2
  prog->add_entry_point(atom(133), 288);  // main / 1
}
int

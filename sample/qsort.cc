      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 264:  // qsort/2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_nil(reg::out(3));
      MACRO_execute(265,3);  // execute(qsort/3)
    case 265:  // qsort/3
      ...
      MACRO_spawn(269,266);  // spawn(part/4)
    case 266:  // return_from_spawn(part/4)
      MACRO_par(7);
      MACRO_out_value(reg::x(6),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_write_value(reg::x(4));
      MACRO_write_variable(reg::x(4));
      MACRO_spawn(265,267);  // spawn(qsort/3)
    case 267:  // return_from_spawn(qsort/3)
      MACRO_tail(7);
      MACRO_out_value(reg::x(5),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 270:  // return_from_call((<)/2)
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::x(6),reg::out(4));
      MACRO_execute(269,4);  // execute(part/4)
    case 271:  // part/4-2
    ...
    case 276:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(274,2);  // execute(atom_number_list/2)
    case 277:  // printstream/1
      MACRO_goal(277,atom(125));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(46,278);  // spawn(outstream/1)
    case 278:  // return_from_spawn(outstream/1)
      MACRO_tail(3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(279,2);  // execute(printstream/2)
    case 279:  // printstream/2
      MACRO_goal(279,atom(126));
      MACRO_requires(7);
    ...
    case 283:  // main/1
      ...
      MACRO_spawn(274,284);  // spawn(atom_number_list/2)
    case 284:  // return_from_spawn(atom_number_list/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(277,285);  // spawn(printstream/1)
    case 285:  // return_from_spawn(printstream/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(264,2);  // execute(qsort/2)
    case 286:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(121), 264);  // qsort / 2
  prog->add_entry_point(atom(122), 265);  // qsort / 3
  prog->add_entry_point(atom(123), 269);  // part / 4
  prog->add_entry_point(atom(124), 274);  // atom_number_list / 2
  prog->add_entry_point(atom(125), 277);  // printstream / 1
  prog->add_entry_point(atom(126), 279);  // printstream / 2
  prog->add_entry_point(atom(127), 281);  // printstream_rest / 2

      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 266:  // qsort/2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_nil(reg::out(3));
      MACRO_execute(267,3);  // execute(qsort/3)
    case 267:  // qsort/3
      ...
      MACRO_spawn(271,268);  // spawn(part/4)
    case 268:  // return_from_spawn(part/4)
      MACRO_par(7);
      MACRO_out_value(reg::x(6),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_write_value(reg::x(4));
      MACRO_write_variable(reg::x(4));
      MACRO_spawn(267,269);  // spawn(qsort/3)
    case 269:  // return_from_spawn(qsort/3)
      MACRO_tail(7);
      MACRO_out_value(reg::x(5),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 272:  // return_from_call((<)/2)
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::x(6),reg::out(4));
      MACRO_execute(271,4);  // execute(part/4)
    case 273:  // part/4-2
    ...
    case 277:  // atom_number_list/2-2
      ...
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_spawn(42,278);  // spawn(atom_number/2)
    case 278:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(276,2);  // execute(atom_number_list/2)
    case 279:  // printstream/1
      ...
      MACRO_par(3);
      MACRO_out_variable(reg::x(2),reg::out(1));
      MACRO_spawn(48,280);  // spawn(outstream/1)
    ...
    case 285:  // main/1
      ...
      MACRO_spawn(276,286);  // spawn(atom_number_list/2)
    case 286:  // return_from_spawn(atom_number_list/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(279,287);  // spawn(printstream/1)
    case 287:  // return_from_spawn(printstream/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(266,2);  // execute(qsort/2)
    case 288:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  atom(123) = to_atom("qsort", 2);
  atom(124) = to_atom("qsort", 3);
  atom(125) = to_atom("part", 4);
  atom(126) = to_atom("atom_number_list", 2);
  ...
  prog->add_entry_point(atom(123), 266);  // qsort / 2
  prog->add_entry_point(atom(124), 267);  // qsort / 3
  prog->add_entry_point(atom(125), 271);  // part / 4
  prog->add_entry_point(atom(126), 276);  // atom_number_list / 2
  prog->add_entry_point(atom(127), 279);  // printstream / 1
  prog->add_entry_point(atom(128), 281);  // printstream / 2
  prog->add_entry_point(atom(129), 283);  // printstream_rest / 2
  prog->add_entry_point(atom(130), 285);  // main / 1
}
int

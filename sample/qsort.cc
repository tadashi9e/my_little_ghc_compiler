...
Q atom(127);  // qsort / 3
Q atom(128);  // part / 4
Q atom(129);  // atom_number_list / 2
Q atom(130);  // printstream / 1
Q atom(131);  // printstream / 2
Q atom(132);  // printstream_rest / 2
Q atom(133);  // main / 1
Q atom(134);  // usage:  / 0
Q atom(135);  //  <Numbers...> / 0
      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 273:  // qsort/2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_nil(reg::out(3));
      MACRO_execute(274,3);  // execute(qsort/3)
    case 274:  // qsort/3
      ...
      MACRO_spawn(278,275,atom(128));  // spawn(part/4)
    case 275:  // return_from_spawn(part/4)
      MACRO_par(3,7);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_spawn(274,276,atom(127));  // spawn(qsort/3)
    case 276:  // return_from_spawn(qsort/3)
      MACRO_tail(3,7);
      MACRO_out_value(reg::y(5),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 278:  // part/4
      ...
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_call(167,279,atom(86));  // call((<)/2)
    case 279:  // return_from_call((<)/2)
      ...
      MACRO_execute(278,4);  // execute(part/4)
    case 280:  // part/4-2
      ...
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_call(164,281,atom(83));  // call((>=)/2)
    case 281:  // return_from_call((>=)/2)
      MACRO_activate;
      MACRO_get_list(reg::in(3));
      MACRO_unify_value(reg::x(6));
      MACRO_unify_variable(reg::x(6));
    ...
    case 282:  // part/4-3
      ...
      MACRO_proceed;
    case 283:  // atom_number_list/2
      MACRO_goal(283,atom(129));
      MACRO_requires(8);
    ...
    case 284:  // atom_number_list/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(48,285,atom(26));  // spawn(atom_number/2)
    case 285:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(5),reg::out(2));
      MACRO_execute(283,2);  // execute(atom_number_list/2)
    case 286:  // printstream/1
      MACRO_goal(286,atom(130));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(1,3);
      MACRO_out_variable(reg::y(2),reg::out(1));
      MACRO_spawn(54,287,atom(29));  // spawn(outstream/1)
    case 287:  // return_from_spawn(outstream/1)
      MACRO_tail(2,3);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::y(2),reg::out(2));
      MACRO_execute(288,2);  // execute(printstream/2)
    case 288:  // printstream/2
      MACRO_goal(288,atom(131));
      MACRO_requires(7);
    ...
    case 289:  // printstream/2-2
      ...
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(290,2);  // execute(printstream_rest/2)
    case 290:  // printstream_rest/2
      MACRO_goal(290,atom(132));
      MACRO_requires(7);
      MACRO_try_guard_else(291);
      MACRO_check_nil(reg::in(1));
      MACRO_activate;
      MACRO_get_list(reg::in(2));
      MACRO_unify_constant(atom(37));
      MACRO_unify_nil;
      MACRO_proceed;
    case 291:  // printstream_rest/2-2
      MACRO_try_guard_else_suspend;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(4));
      MACRO_read_variable(reg::x(3));
    ...
    case 292:  // main/1
      ...
      MACRO_spawn(283,293,atom(129));  // spawn(atom_number_list/2)
    case 293:  // return_from_spawn(atom_number_list/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(286,294,atom(130));  // spawn(printstream/1)
    case 294:  // return_from_spawn(printstream/1)
      MACRO_tail(2,4);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_execute(273,2);  // execute(qsort/2)
    case 295:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(4));
...
void setup(Program* prog) {
  ...
  atom(126) = to_atom("qsort", 2);
  atom(127) = to_atom("qsort", 3);
  atom(128) = to_atom("part", 4);
  atom(129) = to_atom("atom_number_list", 2);
  atom(130) = to_atom("printstream", 1);
  atom(131) = to_atom("printstream", 2);
  atom(132) = to_atom("printstream_rest", 2);
  atom(133) = to_atom("main", 1);
  atom(134) = to_atom("usage: ", 0);
  atom(135) = to_atom(" <Numbers...>", 0);
  // setup entry points
  ...
  prog->add_entry_point(atom(126), 273);  // qsort / 2
  prog->add_entry_point(atom(127), 274);  // qsort / 3
  prog->add_entry_point(atom(128), 278);  // part / 4
  prog->add_entry_point(atom(129), 283);  // atom_number_list / 2
  prog->add_entry_point(atom(130), 286);  // printstream / 1
  prog->add_entry_point(atom(131), 288);  // printstream / 2
  prog->add_entry_point(atom(132), 290);  // printstream_rest / 2
  prog->add_entry_point(atom(133), 292);  // main / 1
}
int

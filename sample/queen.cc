...
Q atom(123);  // usage:  / 0
Q atom(124);  //  <N> / 0
Q atom(125);  // report_results / 2
Q atom(126);  // report_results / 3
Q atom(127);  // report1 / 3
Q atom(128);  // : / 0
Q atom(129);  // queen / 5
Q atom(130);  // check / 8
Q atom(131);  // concat / 3
...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(122) = to_atom("go", 2);
    atom(123) = to_atom("usage: ", 0);
    atom(124) = to_atom(" <N>", 0);
    atom(125) = to_atom("report_results", 2);
    atom(126) = to_atom("report_results", 3);
    atom(127) = to_atom("report1", 3);
    atom(128) = to_atom(":", 0);
    atom(129) = to_atom("queen", 5);
    atom(130) = to_atom("check", 8);
    atom(131) = to_atom("concat", 3);
    atom(132) = to_atom("gen", 2);
    // setup entry points
    ...
    prog->add_entry_point(atom(125), &&L269);  // report_results / 2
    prog->add_entry_point(atom(126), &&L270);  // report_results / 3
    prog->add_entry_point(atom(127), &&L273);  // report1 / 3
    prog->add_entry_point(atom(122), &&L274);  // go / 2
    prog->add_entry_point(atom(129), &&L276);  // queen / 5
    prog->add_entry_point(atom(130), &&L280);  // check / 8
    prog->add_entry_point(atom(131), &&L294);  // concat / 3
    prog->add_entry_point(atom(132), &&L296);  // gen / 2
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
 ...
 L264:  // main/1
  ...
  MACRO_spawn(L40, L265);  // spawn(atom_number/2)
 L265:  // return_from_spawn(atom_number/2)
  MACRO_par(3);
  MACRO_out_structure(atom(122),reg::out(1));
  MACRO_write_value(reg::x(2));
  MACRO_write_variable(reg::x(2));
  MACRO_spawn(L4, L266);  // spawn(time/1)
 L266:  // return_from_spawn(time/1)
  MACRO_par(4);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_spawn(L46, L267);  // spawn(outstream/1)
 L267:  // return_from_spawn(outstream/1)
  ...
  MACRO_write_nil;
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_execute(L269, 2);  // execute(report_results/2)
 L268:  // main/1-2
  MACRO_otherwise;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(2));
  ...
  MACRO_write_nil;
  MACRO_execute(L46, 1);  // execute(outstream/1)
 L269:  // report_results/2
  MACRO_goal(L269, atom(125));
  MACRO_requires(8);
  MACRO_try_guard_else_suspend;
  ...
  MACRO_execute(L270, 3);  // execute(report_results/3)
 L270:  // report_results/3
  MACRO_goal(L270, atom(126));
  MACRO_requires(11);
  MACRO_try_guard_else_suspend;
  MACRO_check_structure(atom(85),reg::in(1));
  MACRO_read_variable(reg::x(6));
  ...
  MACRO_out_value(reg::in(3),reg::out(3));
  MACRO_spawn(L273, L271);  // spawn(report1/3)
 L271:  // return_from_spawn(report1/3)
  MACRO_par(8);
  MACRO_out_value(reg::in(3),reg::out(1));
  MACRO_out_variable(reg::x(7),reg::out(2));
  MACRO_call(L214, L272);  // call(__inc__/2)
 L272:  // return_from_call(__inc__/2)
  MACRO_tail(8);
  MACRO_out_structure(atom(85),reg::out(1));
  MACRO_write_value(reg::x(6));
  MACRO_write_value(reg::x(4));
 ...
 L274:  // go/2
  ...
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(3),reg::out(2));
  MACRO_spawn(L296, L275);  // spawn(gen/2)
 L275:  // return_from_spawn(gen/2)
  MACRO_tail(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  ...
  MACRO_execute(L276, 5);  // execute(queen/5)
 L276:  // queen/5
  MACRO_goal(L276, atom(129));
  MACRO_requires(17);
  MACRO_try_guard_else(L277);
  MACRO_check_nil(reg::in(1));
  MACRO_check_nil(reg::in(2));
  MACRO_activate;
 ...
 L278:  // queen/5-3
  ...
  MACRO_spawn(L280, L279);  // spawn(check/8)
 L279:  // return_from_spawn(check/8)
  MACRO_tail(9);
 ...
 L280:  // check/8
  ...
  MACRO_spawn(L294, L281);  // spawn(concat/3)
 L281:  // return_from_spawn(concat/3)
  MACRO_tail(10);
 ...
 L282:  // check/8-2
  ...
  MACRO_call(L174, L283);  // call(__add__/3)
 L283:  // return_from_call(__add__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(11),reg::out(2));
  MACRO_call(L162, L284);  // call((=\=)/2)
 L284:  // return_from_call((=\=)/2)
  MACRO_seq(12);
  MACRO_out_value(reg::x(10),reg::out(1));
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(10),reg::out(3));
  MACRO_call(L180, L285);  // call(__sub__/3)
 L285:  // return_from_call(__sub__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(10),reg::out(2));
  MACRO_call(L162, L286);  // call((=\=)/2)
 L286:  // return_from_call((=\=)/2)
  MACRO_activate;
  MACRO_par(12);
  MACRO_out_value(reg::in(3),reg::out(1));
  MACRO_out_variable(reg::x(10),reg::out(2));
  MACRO_call(L214, L287);  // call(__inc__/2)
 L287:  // return_from_call(__inc__/2)
  MACRO_tail(12);
  MACRO_out_value(reg::x(9),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  ...
  MACRO_execute(L280, 8);  // execute(check/8)
 L288:  // check/8-3
  ...
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(9),reg::out(3));
  MACRO_call(L174, L289);  // call(__add__/3)
 L289:  // return_from_call(__add__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(9),reg::out(2));
  MACRO_call(L159, L290);  // call((=:=)/2)
 L290:  // return_from_call((=:=)/2)
  MACRO_activate;
 ...
 L291:  // check/8-4
  ...
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(9),reg::out(3));
  MACRO_call(L180, L292);  // call(__sub__/3)
 L292:  // return_from_call(__sub__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(9),reg::out(2));
  MACRO_call(L159, L293);  // call((=:=)/2)
 L293:  // return_from_call((=:=)/2)
  MACRO_activate;
  MACRO_get_value(reg::in(8),reg::in(7));
  MACRO_proceed;
 L294:  // concat/3
  MACRO_goal(L294, atom(131));
  MACRO_requires(9);
 ...
 L295:  // concat/3-2
  ...
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_out_value(reg::x(5),reg::out(3));
  MACRO_execute(L294, 3);  // execute(concat/3)
 L296:  // gen/2
  MACRO_goal(L296, atom(132));
  MACRO_requires(7);
  MACRO_try_guard_else(L299);
  MACRO_seq(4);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
  MACRO_call(L157, L297);  // call((>)/2)
 L297:  // return_from_call((>)/2)
  MACRO_activate;
  ...
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(4),reg::out(2));
  MACRO_call(L218, L298);  // call(__dec__/2)
 L298:  // return_from_call(__dec__/2)
  MACRO_tail(5);
  MACRO_out_value(reg::x(4),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_execute(L296, 2);  // execute(gen/2)
 L299:  // gen/2-2
  MACRO_try_guard_else_suspend;
  MACRO_seq(5);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
  MACRO_call(L166, L300);  // call((:=)/2)
 L300:  // return_from_call((:=)/2)
  MACRO_seq(5);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_call(L159, L301);  // call((=:=)/2)
 L301:  // return_from_call((=:=)/2)
  MACRO_activate;

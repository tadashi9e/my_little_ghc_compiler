      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 266:  // main/1
      ...
      MACRO_spawn(42,267);  // spawn(atom_number/2)
    case 267:  // return_from_spawn(atom_number/2)
      ...
      MACRO_spawn(4,268);  // spawn(time/1)
    case 268:  // return_from_spawn(time/1)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(48,269);  // spawn(outstream/1)
    case 269:  // return_from_spawn(outstream/1)
      MACRO_tail(4);
      MACRO_out_structure(atom(87),reg::out(1));
      MACRO_write_value(reg::x(3));
      MACRO_write_nil;
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(271,2);  // execute(report_results/2)
    case 270:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
      ...
      MACRO_write_nil;
      MACRO_execute(48,1);  // execute(outstream/1)
    case 271:  // report_results/2
      MACRO_goal(271,atom(127));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      ...
      MACRO_execute(272,3);  // execute(report_results/3)
    case 272:  // report_results/3
      MACRO_goal(272,atom(128));
      MACRO_requires(11);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(87),reg::in(1));
      MACRO_read_variable(reg::x(6));
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(275,273);  // spawn(report1/3)
    case 273:  // return_from_spawn(report1/3)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(216,274);  // call(__inc__/2)
    case 274:  // return_from_call(__inc__/2)
      MACRO_tail(8);
      MACRO_out_structure(atom(87),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_value(reg::x(4));
    ...
    case 276:  // go/2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(3),reg::out(2));
      MACRO_spawn(298,277);  // spawn(gen/2)
    case 277:  // return_from_spawn(gen/2)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      ...
      MACRO_execute(278,5);  // execute(queen/5)
    case 278:  // queen/5
      MACRO_goal(278,atom(131));
      MACRO_requires(17);
    ...
    case 280:  // queen/5-3
      ...
      MACRO_spawn(282,281);  // spawn(check/8)
    case 281:  // return_from_spawn(check/8)
      MACRO_tail(9);
    ...
    case 282:  // check/8
      ...
      MACRO_spawn(296,283);  // spawn(concat/3)
    case 283:  // return_from_spawn(concat/3)
      MACRO_tail(10);
    ...
    case 284:  // check/8-2
      ...
      MACRO_call(176,285);  // call(__add__/3)
    case 285:  // return_from_call(__add__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(11),reg::out(2));
      MACRO_call(164,286);  // call((=\=)/2)
    case 286:  // return_from_call((=\=)/2)
      MACRO_seq(12);
      MACRO_out_value(reg::x(10),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(10),reg::out(3));
      MACRO_call(182,287);  // call(__sub__/3)
    case 287:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(10),reg::out(2));
      MACRO_call(164,288);  // call((=\=)/2)
    case 288:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_par(12);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(10),reg::out(2));
      MACRO_call(216,289);  // call(__inc__/2)
    case 289:  // return_from_call(__inc__/2)
      MACRO_tail(12);
      MACRO_out_value(reg::x(9),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_execute(282,8);  // execute(check/8)
    case 290:  // check/8-3
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(9),reg::out(3));
      MACRO_call(176,291);  // call(__add__/3)
    case 291:  // return_from_call(__add__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(9),reg::out(2));
      MACRO_call(161,292);  // call((=:=)/2)
    ...
    case 293:  // check/8-4
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(9),reg::out(3));
      MACRO_call(182,294);  // call(__sub__/3)
    case 294:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(9),reg::out(2));
      MACRO_call(161,295);  // call((=:=)/2)
    case 295:  // return_from_call((=:=)/2)
      MACRO_activate;
      MACRO_get_value(reg::in(8),reg::in(7));
      MACRO_proceed;
    case 296:  // concat/3
      MACRO_goal(296,atom(133));
      MACRO_requires(9);
    ...
    case 297:  // concat/3-2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(296,3);  // execute(concat/3)
    case 298:  // gen/2
      MACRO_goal(298,atom(134));
      MACRO_requires(7);
      MACRO_try_guard_else(301);
      MACRO_seq(4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(159,299);  // call((>)/2)
    case 299:  // return_from_call((>)/2)
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_call(220,300);  // call(__dec__/2)
    case 300:  // return_from_call(__dec__/2)
      MACRO_tail(5);
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(298,2);  // execute(gen/2)
    case 301:  // gen/2-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(5);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(168,302);  // call((:=)/2)
    case 302:  // return_from_call((:=)/2)
      MACRO_seq(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_call(161,303);  // call((=:=)/2)
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(127), 271);  // report_results / 2
  prog->add_entry_point(atom(128), 272);  // report_results / 3
  prog->add_entry_point(atom(129), 275);  // report1 / 3
  prog->add_entry_point(atom(124), 276);  // go / 2
  prog->add_entry_point(atom(131), 278);  // queen / 5
  prog->add_entry_point(atom(132), 282);  // check / 8
  prog->add_entry_point(atom(133), 296);  // concat / 3
  prog->add_entry_point(atom(134), 298);  // gen / 2
}
int

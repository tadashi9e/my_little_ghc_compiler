      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 269:  // main/1
      ...
      MACRO_spawn(48,270,atom(26));  // spawn(atom_number/2)
    case 270:  // return_from_spawn(atom_number/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(13,271,atom(9));  // spawn(wait_time/1)
    case 271:  // return_from_spawn(wait_time/1)
      MACRO_par(2,4);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_spawn(280,272,atom(127));  // spawn(go/2)
    case 272:  // return_from_spawn(go/2)
      MACRO_par(1,5);
      MACRO_out_variable(reg::y(4),reg::out(1));
      MACRO_spawn(54,273,atom(29));  // spawn(outstream/1)
    case 273:  // return_from_spawn(outstream/1)
      MACRO_tail(2,5);
      MACRO_out_structure(atom(92),reg::out(1));
      MACRO_write_value(reg::y(4));
      MACRO_write_nil;
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_execute(275,2);  // execute(report_results/2)
    case 274:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(5));
      ...
      MACRO_write_nil;
      MACRO_execute(54,1);  // execute(outstream/1)
    case 275:  // report_results/2
      MACRO_goal(275,atom(130));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      ...
      MACRO_execute(276,3);  // execute(report_results/3)
    case 276:  // report_results/3
      MACRO_goal(276,atom(131));
      MACRO_requires(12);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(92),reg::in(1));
      MACRO_read_variable(reg::x(4));
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(279,277,atom(132));  // spawn(report1/3)
    case 277:  // return_from_spawn(report1/3)
      MACRO_par(2,9);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::y(4),reg::out(2));
      MACRO_spawn(219,278,atom(43));  // spawn(__inc__/2)
    case 278:  // return_from_spawn(__inc__/2)
      MACRO_tail(3,9);
      MACRO_out_structure(atom(92),reg::out(1));
    ...
    case 280:  // go/2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(302,281,atom(134));  // spawn(gen/2)
    case 281:  // return_from_spawn(gen/2)
      MACRO_tail(5,6);
      MACRO_out_value(reg::y(3),reg::out(1));
      ...
      MACRO_execute(282,5);  // execute(queen/5)
    case 282:  // queen/5
      MACRO_goal(282,atom(135));
      MACRO_requires(17);
    ...
    case 284:  // queen/5-3
      ...
      MACRO_spawn(286,285,atom(136));  // spawn(check/8)
    case 285:  // return_from_spawn(check/8)
      MACRO_tail(5,9);
      MACRO_out_value(reg::x(8),reg::out(1));
      MACRO_out_list(reg::out(2));
      MACRO_write_value(reg::x(7));
    ...
    case 286:  // check/8
      ...
      MACRO_out_variable(reg::y(9),reg::out(3));
      MACRO_spawn(300,287,atom(137));  // spawn(concat/3)
    case 287:  // return_from_spawn(concat/3)
      MACRO_tail(5,10);
    ...
    case 288:  // check/8-2
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(10),reg::out(3));
      MACRO_call(179,289,atom(45));  // call(__add__/3)
    case 289:  // return_from_call(__add__/3)
      MACRO_seq(2,14);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(10),reg::out(2));
      MACRO_call(169,290,atom(88));  // call((=\=)/2)
    case 290:  // return_from_call((=\=)/2)
      MACRO_seq(3,14);
      MACRO_out_value(reg::x(11),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(11),reg::out(3));
      MACRO_call(185,291,atom(97));  // call(__sub__/3)
    case 291:  // return_from_call(__sub__/3)
      MACRO_seq(2,14);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(11),reg::out(2));
      MACRO_call(169,292,atom(88));  // call((=\=)/2)
    case 292:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_par(2,14);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::y(12),reg::out(2));
      MACRO_spawn(219,293,atom(43));  // spawn(__inc__/2)
    case 293:  // return_from_spawn(__inc__/2)
      MACRO_tail(8,14);
      MACRO_out_value(reg::x(13),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_execute(286,8);  // execute(check/8)
    case 294:  // check/8-3
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(13),reg::out(3));
      MACRO_call(179,295,atom(45));  // call(__add__/3)
    case 295:  // return_from_call(__add__/3)
      MACRO_seq(2,15);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(13),reg::out(2));
      MACRO_call(168,296,atom(87));  // call((=:=)/2)
    ...
    case 297:  // check/8-4
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(14),reg::out(3));
      MACRO_call(185,298,atom(97));  // call(__sub__/3)
    case 298:  // return_from_call(__sub__/3)
      MACRO_seq(2,16);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(14),reg::out(2));
      MACRO_call(168,299,atom(87));  // call((=:=)/2)
    case 299:  // return_from_call((=:=)/2)
      MACRO_activate;
      MACRO_get_value(reg::in(8),reg::in(7));
      MACRO_proceed;
    case 300:  // concat/3
      MACRO_goal(300,atom(137));
      MACRO_requires(9);
    ...
    case 301:  // concat/3-2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(300,3);  // execute(concat/3)
    case 302:  // gen/2
      MACRO_goal(302,atom(134));
      MACRO_requires(8);
      MACRO_try_guard_else(305);
      MACRO_seq(2,4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(166,303,atom(85));  // call((>)/2)
    case 303:  // return_from_call((>)/2)
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(223,304,atom(108));  // spawn(__dec__/2)
    case 304:  // return_from_spawn(__dec__/2)
      MACRO_tail(2,5);
      MACRO_out_value(reg::y(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(302,2);  // execute(gen/2)
    case 305:  // gen/2-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(2,5);
      MACRO_out_variable(reg::y(4),reg::out(1));
      MACRO_out_value(reg::in(1),reg::out(2));
      MACRO_call(171,306,atom(90));  // call((:=)/2)
    case 306:  // return_from_call((:=)/2)
      MACRO_seq(2,6);
      MACRO_out_variable(reg::y(5),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(171,307,atom(90));  // call((:=)/2)
    case 307:  // return_from_call((:=)/2)
      MACRO_seq(2,6);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_out_value(reg::y(5),reg::out(2));
      MACRO_call(168,308,atom(87));  // call((=:=)/2)
    case 308:  // return_from_call((=:=)/2)
      MACRO_activate;
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(126), 269);  // main / 1
  prog->add_entry_point(atom(130), 275);  // report_results / 2
  prog->add_entry_point(atom(131), 276);  // report_results / 3
  prog->add_entry_point(atom(132), 279);  // report1 / 3
  prog->add_entry_point(atom(127), 280);  // go / 2
  prog->add_entry_point(atom(135), 282);  // queen / 5
  prog->add_entry_point(atom(136), 286);  // check / 8
  prog->add_entry_point(atom(137), 300);  // concat / 3
  prog->add_entry_point(atom(134), 302);  // gen / 2
}
int

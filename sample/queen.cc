      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 265:  // return_from_spawn(atom_number/2)
      ...
      MACRO_spawn(4,266);  // spawn(time/1)
    case 266:  // return_from_spawn(time/1)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(46,267);  // spawn(outstream/1)
    case 267:  // return_from_spawn(outstream/1)
      ...
      MACRO_write_nil;
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(269,2);  // execute(report_results/2)
    case 268:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
      ...
      MACRO_write_nil;
      MACRO_execute(46,1);  // execute(outstream/1)
    case 269:  // report_results/2
      MACRO_goal(269,atom(125));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      ...
      MACRO_execute(270,3);  // execute(report_results/3)
    case 270:  // report_results/3
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(273,271);  // spawn(report1/3)
    case 271:  // return_from_spawn(report1/3)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(214,272);  // call(__inc__/2)
    case 272:  // return_from_call(__inc__/2)
      MACRO_tail(8);
      MACRO_out_structure(atom(85),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_value(reg::x(4));
    ...
    case 274:  // go/2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(3),reg::out(2));
      MACRO_spawn(296,275);  // spawn(gen/2)
    case 275:  // return_from_spawn(gen/2)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      ...
      MACRO_execute(276,5);  // execute(queen/5)
    case 276:  // queen/5
      MACRO_goal(276,atom(129));
      MACRO_requires(17);
    ...
    case 278:  // queen/5-3
      ...
      MACRO_spawn(280,279);  // spawn(check/8)
    case 279:  // return_from_spawn(check/8)
      MACRO_tail(9);
    ...
    case 280:  // check/8
      ...
      MACRO_spawn(294,281);  // spawn(concat/3)
    case 281:  // return_from_spawn(concat/3)
      MACRO_tail(10);
    ...
    case 282:  // check/8-2
      ...
      MACRO_call(174,283);  // call(__add__/3)
    case 283:  // return_from_call(__add__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(11),reg::out(2));
      MACRO_call(162,284);  // call((=\=)/2)
    case 284:  // return_from_call((=\=)/2)
      MACRO_seq(12);
      MACRO_out_value(reg::x(10),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(10),reg::out(3));
      MACRO_call(180,285);  // call(__sub__/3)
    case 285:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(10),reg::out(2));
      MACRO_call(162,286);  // call((=\=)/2)
    case 286:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_par(12);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(10),reg::out(2));
      MACRO_call(214,287);  // call(__inc__/2)
    case 287:  // return_from_call(__inc__/2)
      MACRO_tail(12);
      MACRO_out_value(reg::x(9),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_execute(280,8);  // execute(check/8)
    case 288:  // check/8-3
    ...
    case 291:  // check/8-4
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(9),reg::out(3));
      MACRO_call(180,292);  // call(__sub__/3)
    case 292:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(9),reg::out(2));
      MACRO_call(159,293);  // call((=:=)/2)
    case 293:  // return_from_call((=:=)/2)
      MACRO_activate;
      MACRO_get_value(reg::in(8),reg::in(7));
      MACRO_proceed;
    case 294:  // concat/3
      MACRO_goal(294,atom(131));
      MACRO_requires(9);
    ...
    case 295:  // concat/3-2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(294,3);  // execute(concat/3)
    case 296:  // gen/2
      MACRO_goal(296,atom(132));
      MACRO_requires(7);
      MACRO_try_guard_else(299);
      MACRO_seq(4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(157,297);  // call((>)/2)
    case 297:  // return_from_call((>)/2)
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_call(218,298);  // call(__dec__/2)
    case 298:  // return_from_call(__dec__/2)
      MACRO_tail(5);
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(296,2);  // execute(gen/2)
    case 299:  // gen/2-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(5);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(166,300);  // call((:=)/2)
    case 300:  // return_from_call((:=)/2)
      MACRO_seq(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_call(159,301);  // call((=:=)/2)
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(121), 264);  // main / 1
  prog->add_entry_point(atom(125), 269);  // report_results / 2
  prog->add_entry_point(atom(126), 270);  // report_results / 3
  prog->add_entry_point(atom(127), 273);  // report1 / 3
  prog->add_entry_point(atom(122), 274);  // go / 2
  prog->add_entry_point(atom(129), 276);  // queen / 5
  prog->add_entry_point(atom(130), 280);  // check / 8
  prog->add_entry_point(atom(131), 294);  // concat / 3
  prog->add_entry_point(atom(132), 296);  // gen / 2
}
int

...
Q atom(125);  // usage:  / 0
Q atom(126);  //  <N> / 0
Q atom(127);  // report_results / 2
Q atom(128);  // report_results / 3
Q atom(129);  // report1 / 3
Q atom(130);  // : / 0
Q atom(131);  // queen / 5
Q atom(132);  // check / 8
Q atom(133);  // concat / 3
...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    atom(126) = to_atom(" <N>", 0);
    atom(127) = to_atom("report_results", 2);
    atom(128) = to_atom("report_results", 3);
    atom(129) = to_atom("report1", 3);
    atom(130) = to_atom(":", 0);
    atom(131) = to_atom("queen", 5);
    atom(132) = to_atom("check", 8);
    atom(133) = to_atom("concat", 3);
    ...
    prog->add_entry_point(atom(127), &&L271);  // report_results / 2
    prog->add_entry_point(atom(128), &&L272);  // report_results / 3
    prog->add_entry_point(atom(129), &&L275);  // report1 / 3
    prog->add_entry_point(atom(124), &&L276);  // go / 2
    prog->add_entry_point(atom(131), &&L278);  // queen / 5
    prog->add_entry_point(atom(132), &&L282);  // check / 8
    prog->add_entry_point(atom(133), &&L296);  // concat / 3
    prog->add_entry_point(atom(134), &&L298);  // gen / 2
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
 ...
 L266:  // main/1
  ...
  MACRO_spawn(L42, L267);  // spawn(atom_number/2)
 L267:  // return_from_spawn(atom_number/2)
  MACRO_par(3);
  MACRO_out_structure(atom(124),reg::out(1));
  MACRO_write_value(reg::x(2));
  MACRO_write_variable(reg::x(2));
  MACRO_spawn(L6, L268);  // spawn(time/1)
 L268:  // return_from_spawn(time/1)
  MACRO_par(4);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_spawn(L48, L269);  // spawn(outstream/1)
 L269:  // return_from_spawn(outstream/1)
  MACRO_tail(4);
  MACRO_out_structure(atom(87),reg::out(1));
  MACRO_write_value(reg::x(3));
  MACRO_write_nil;
  MACRO_out_value(reg::x(2),reg::out(2));
  MACRO_execute(L271, 2);  // execute(report_results/2)
 L270:  // main/1-2
  MACRO_otherwise;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(2));
  ...
  MACRO_write_nil;
  MACRO_execute(L48, 1);  // execute(outstream/1)
 L271:  // report_results/2
  MACRO_goal(L271, atom(127));
  MACRO_requires(8);
  MACRO_try_guard_else_suspend;
  MACRO_check_structure(atom(87),reg::in(1));
  MACRO_read_variable(reg::x(3));
  MACRO_read_variable(reg::x(4));
  MACRO_activate;
  MACRO_tail(5);
  ...
  MACRO_execute(L272, 3);  // execute(report_results/3)
 L272:  // report_results/3
  MACRO_goal(L272, atom(128));
  MACRO_requires(11);
  MACRO_try_guard_else_suspend;
  MACRO_check_structure(atom(87),reg::in(1));
  MACRO_read_variable(reg::x(6));
  ...
  MACRO_out_value(reg::in(3),reg::out(3));
  MACRO_spawn(L275, L273);  // spawn(report1/3)
 L273:  // return_from_spawn(report1/3)
  MACRO_par(8);
  MACRO_out_value(reg::in(3),reg::out(1));
  MACRO_out_variable(reg::x(7),reg::out(2));
  MACRO_call(L216, L274);  // call(__inc__/2)
 L274:  // return_from_call(__inc__/2)
  MACRO_tail(8);
  MACRO_out_structure(atom(87),reg::out(1));
  MACRO_write_value(reg::x(6));
  MACRO_write_value(reg::x(4));
 ...
 L276:  // go/2
  ...
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(3),reg::out(2));
  MACRO_spawn(L298, L277);  // spawn(gen/2)
 L277:  // return_from_spawn(gen/2)
  MACRO_tail(4);
  MACRO_out_value(reg::x(3),reg::out(1));
  ...
  MACRO_execute(L278, 5);  // execute(queen/5)
 L278:  // queen/5
  MACRO_goal(L278, atom(131));
  MACRO_requires(17);
 ...
 L280:  // queen/5-3
  ...
  MACRO_spawn(L282, L281);  // spawn(check/8)
 L281:  // return_from_spawn(check/8)
  MACRO_tail(9);
  ...
  MACRO_execute(L278, 5);  // execute(queen/5)
 L282:  // check/8
  MACRO_goal(L282, atom(132));
  MACRO_requires(20);
  MACRO_try_guard_else(L284);
  MACRO_check_nil(reg::in(1));
  MACRO_activate;
  MACRO_par(10);
  MACRO_out_value(reg::in(4),reg::out(1));
  ...
  MACRO_spawn(L296, L283);  // spawn(concat/3)
 L283:  // return_from_spawn(concat/3)
  MACRO_tail(10);
 ...
 L284:  // check/8-2
  ...
  MACRO_call(L176, L285);  // call(__add__/3)
 L285:  // return_from_call(__add__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(11),reg::out(2));
  MACRO_call(L164, L286);  // call((=\=)/2)
 L286:  // return_from_call((=\=)/2)
  MACRO_seq(12);
  MACRO_out_value(reg::x(10),reg::out(1));
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(10),reg::out(3));
  MACRO_call(L182, L287);  // call(__sub__/3)
 L287:  // return_from_call(__sub__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(10),reg::out(2));
  MACRO_call(L164, L288);  // call((=\=)/2)
 L288:  // return_from_call((=\=)/2)
  MACRO_activate;
  MACRO_par(12);
  MACRO_out_value(reg::in(3),reg::out(1));
  MACRO_out_variable(reg::x(10),reg::out(2));
  MACRO_call(L216, L289);  // call(__inc__/2)
 L289:  // return_from_call(__inc__/2)
  MACRO_tail(12);
  MACRO_out_value(reg::x(9),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  ...
  MACRO_execute(L282, 8);  // execute(check/8)
 L290:  // check/8-3
  MACRO_try_guard_else(L293);
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(9));
  MACRO_read_variable(reg::x(10));
  MACRO_seq(12);
  ...
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(9),reg::out(3));
  MACRO_call(L176, L291);  // call(__add__/3)
 L291:  // return_from_call(__add__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(9),reg::out(2));
  MACRO_call(L161, L292);  // call((=:=)/2)
 L292:  // return_from_call((=:=)/2)
  MACRO_activate;
 ...
 L293:  // check/8-4
  ...
  MACRO_out_value(reg::in(3),reg::out(2));
  MACRO_out_variable(reg::x(9),reg::out(3));
  MACRO_call(L182, L294);  // call(__sub__/3)
 L294:  // return_from_call(__sub__/3)
  MACRO_seq(12);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_value(reg::x(9),reg::out(2));
  MACRO_call(L161, L295);  // call((=:=)/2)
 L295:  // return_from_call((=:=)/2)
  MACRO_activate;
  MACRO_get_value(reg::in(8),reg::in(7));
  MACRO_proceed;
 L296:  // concat/3
  MACRO_goal(L296, atom(133));
  MACRO_requires(9);
  MACRO_try_guard_else(L297);
  MACRO_check_nil(reg::in(1));
  MACRO_activate;
  MACRO_get_value(reg::in(2),reg::in(3));
  MACRO_proceed;
 L297:  // concat/3-2
  ...
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_out_value(reg::x(5),reg::out(3));
  MACRO_execute(L296, 3);  // execute(concat/3)
 L298:  // gen/2
  MACRO_goal(L298, atom(134));
  MACRO_requires(7);
  MACRO_try_guard_else(L301);
  MACRO_seq(4);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
  MACRO_call(L159, L299);  // call((>)/2)
 L299:  // return_from_call((>)/2)
  MACRO_activate;
  ...
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(4),reg::out(2));
  MACRO_call(L220, L300);  // call(__dec__/2)
 L300:  // return_from_call(__dec__/2)
  MACRO_tail(5);
  MACRO_out_value(reg::x(4),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_execute(L298, 2);  // execute(gen/2)
 L301:  // gen/2-2
  MACRO_try_guard_else_suspend;
  MACRO_seq(5);
  MACRO_out_variable(reg::x(3),reg::out(1));
  MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
  MACRO_call(L168, L302);  // call((:=)/2)
 L302:  // return_from_call((:=)/2)
  MACRO_seq(5);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_call(L161, L303);  // call((=:=)/2)
 L303:  // return_from_call((=:=)/2)
  MACRO_activate;

...
Q atom(128);  // usage:  / 0
Q atom(129);  //  <N> / 0
Q atom(130);  // report_results / 2
Q atom(131);  // report_results / 3
Q atom(132);  // report1 / 3
Q atom(133);  // : / 0
Q atom(134);  // gen / 2
Q atom(135);  // queen / 5
Q atom(136);  // check / 8
      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 273:  // main/1
      ...
      MACRO_spawn(48,274,atom(26));  // spawn(atom_number/2)
    case 274:  // return_from_spawn(atom_number/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(13,275,atom(9));  // spawn(wait_time/1)
    case 275:  // return_from_spawn(wait_time/1)
      MACRO_par(2,4);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_spawn(284,276,atom(127));  // spawn(go/2)
    case 276:  // return_from_spawn(go/2)
      MACRO_par(1,5);
      MACRO_out_variable(reg::y(4),reg::out(1));
      MACRO_spawn(54,277,atom(29));  // spawn(outstream/1)
    case 277:  // return_from_spawn(outstream/1)
      MACRO_tail(2,5);
      MACRO_out_structure(atom(92),reg::out(1));
      MACRO_write_value(reg::y(4));
      MACRO_write_nil;
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_execute(279,2);  // execute(report_results/2)
    case 278:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(5));
      ...
      MACRO_write_nil;
      MACRO_execute(54,1);  // execute(outstream/1)
    case 279:  // report_results/2
      MACRO_goal(279,atom(130));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(92),reg::in(1));
      MACRO_read_variable(reg::x(3));
      MACRO_read_variable(reg::x(4));
      MACRO_activate;
      MACRO_tail(3,5);
      ...
      MACRO_execute(280,3);  // execute(report_results/3)
    case 280:  // report_results/3
      MACRO_goal(280,atom(131));
      MACRO_requires(12);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(92),reg::in(1));
      MACRO_read_variable(reg::x(4));
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(283,281,atom(132));  // spawn(report1/3)
    case 281:  // return_from_spawn(report1/3)
      MACRO_par(2,9);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::y(4),reg::out(2));
      MACRO_spawn(223,282,atom(43));  // spawn(__inc__/2)
    case 282:  // return_from_spawn(__inc__/2)
      MACRO_tail(3,9);
      MACRO_out_structure(atom(92),reg::out(1));
      MACRO_write_value(reg::x(7));
      MACRO_write_value(reg::x(5));
      MACRO_out_value(reg::x(6),reg::out(2));
      MACRO_out_value(reg::y(4),reg::out(3));
      MACRO_execute(280,3);  // execute(report_results/3)
    case 283:  // report1/3
      MACRO_goal(283,atom(132));
      MACRO_requires(5);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(92),reg::in(1));
      MACRO_read_variable(reg::x(5));
    ...
    case 284:  // go/2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(308,285,atom(134));  // spawn(gen/2)
    case 285:  // return_from_spawn(gen/2)
      MACRO_tail(5,6);
      MACRO_out_value(reg::y(3),reg::out(1));
      ...
      MACRO_execute(286,5);  // execute(queen/5)
    case 286:  // queen/5
      MACRO_goal(286,atom(135));
      MACRO_requires(17);
    ...
    case 288:  // queen/5-3
      ...
      MACRO_out_variable(reg::y(6),reg::out(8));
      MACRO_spawn(290,289,atom(136));  // spawn(check/8)
    case 289:  // return_from_spawn(check/8)
      MACRO_tail(5,9);
      MACRO_out_value(reg::x(8),reg::out(1));
      MACRO_out_list(reg::out(2));
      MACRO_write_value(reg::x(7));
    ...
    case 290:  // check/8
      ...
      MACRO_out_variable(reg::y(9),reg::out(3));
      MACRO_spawn(306,291,atom(137));  // spawn(concat/3)
    case 291:  // return_from_spawn(concat/3)
      MACRO_tail(5,10);
      MACRO_out_value(reg::y(9),reg::out(1));
      MACRO_out_nil(reg::out(2));
    ...
    case 292:  // check/8-2
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(10),reg::out(3));
      MACRO_call(183,293,atom(45));  // call(__add__/3)
    case 293:  // return_from_call(__add__/3)
      MACRO_seq(2,14);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(10),reg::out(2));
      MACRO_call(171,294,atom(89));  // call((=\=)/2)
    case 294:  // return_from_call((=\=)/2)
      MACRO_seq(3,14);
      MACRO_out_value(reg::x(11),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(11),reg::out(3));
      MACRO_call(189,295,atom(97));  // call(__sub__/3)
    case 295:  // return_from_call(__sub__/3)
      MACRO_seq(2,14);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::y(11),reg::out(2));
      MACRO_call(171,296,atom(89));  // call((=\=)/2)
    case 296:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_par(2,14);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::y(12),reg::out(2));
      MACRO_spawn(223,297,atom(43));  // spawn(__inc__/2)
    case 297:  // return_from_spawn(__inc__/2)
      MACRO_tail(8,14);
      MACRO_out_value(reg::x(13),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::y(12),reg::out(3));
      MACRO_out_value(reg::in(4),reg::out(4));
      MACRO_out_value(reg::in(5),reg::out(5));
      MACRO_out_value(reg::in(6),reg::out(6));
      MACRO_out_value(reg::in(7),reg::out(7));
      MACRO_out_value(reg::in(8),reg::out(8));
      MACRO_execute(290,8);  // execute(check/8)
    case 298:  // check/8-3
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(13),reg::out(3));
      MACRO_call(183,299,atom(45));  // call(__add__/3)
    case 299:  // return_from_call(__add__/3)
      MACRO_seq(2,15);
      MACRO_out_variable(reg::y(14),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(175,300,atom(88));  // call((:=)/2)
    case 300:  // return_from_call((:=)/2)
      MACRO_seq(2,15);
      MACRO_out_value(reg::y(14),reg::out(1));
      MACRO_out_value(reg::y(13),reg::out(2));
      MACRO_call(163,301,atom(82));  // call((==)/2)
    case 301:  // return_from_call((==)/2)
      MACRO_activate;
    ...
    case 302:  // check/8-4
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::y(15),reg::out(3));
      MACRO_call(189,303,atom(97));  // call(__sub__/3)
    case 303:  // return_from_call(__sub__/3)
      MACRO_seq(2,17);
      MACRO_out_variable(reg::y(16),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(175,304,atom(88));  // call((:=)/2)
    case 304:  // return_from_call((:=)/2)
      MACRO_seq(2,17);
      MACRO_out_value(reg::y(16),reg::out(1));
      MACRO_out_value(reg::y(15),reg::out(2));
      MACRO_call(163,305,atom(82));  // call((==)/2)
    case 305:  // return_from_call((==)/2)
      MACRO_activate;
      MACRO_get_value(reg::in(8),reg::in(7));
      MACRO_proceed;
    case 306:  // concat/3
      MACRO_goal(306,atom(137));
      MACRO_requires(9);
    ...
    case 307:  // concat/3-2
      ...
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::x(5),reg::out(3));
      MACRO_execute(306,3);  // execute(concat/3)
    case 308:  // gen/2
      MACRO_goal(308,atom(134));
      MACRO_requires(7);
      MACRO_try_guard_else(311);
      MACRO_seq(2,4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(166,309,atom(85));  // call((>)/2)
    case 309:  // return_from_call((>)/2)
      MACRO_activate;
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(3),reg::out(2));
      MACRO_spawn(227,310,atom(108));  // spawn(__dec__/2)
    case 310:  // return_from_spawn(__dec__/2)
      MACRO_tail(2,5);
      MACRO_out_value(reg::y(3),reg::out(1));
      MACRO_out_value(reg::x(4),reg::out(2));
      MACRO_execute(308,2);  // execute(gen/2)
    case 311:  // gen/2-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(2,5);
      MACRO_out_variable(reg::y(4),reg::out(1));
      MACRO_out_value(reg::in(1),reg::out(2));
      MACRO_call(175,312,atom(88));  // call((:=)/2)
    case 312:  // return_from_call((:=)/2)
      MACRO_seq(2,5);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(163,313,atom(82));  // call((==)/2)
    case 313:  // return_from_call((==)/2)
      MACRO_activate;
...
void setup(Program* prog) {
  ...
  atom(126) = to_atom("main", 1);
  atom(127) = to_atom("go", 2);
  atom(128) = to_atom("usage: ", 0);
  atom(129) = to_atom(" <N>", 0);
  atom(130) = to_atom("report_results", 2);
  atom(131) = to_atom("report_results", 3);
  atom(132) = to_atom("report1", 3);
  atom(133) = to_atom(":", 0);
  atom(134) = to_atom("gen", 2);
  atom(135) = to_atom("queen", 5);
  atom(136) = to_atom("check", 8);
  atom(137) = to_atom("concat", 3);
  // setup entry points
  ...
  prog->add_entry_point(atom(126), 273);  // main / 1
  prog->add_entry_point(atom(130), 279);  // report_results / 2
  prog->add_entry_point(atom(131), 280);  // report_results / 3
  prog->add_entry_point(atom(132), 283);  // report1 / 3
  prog->add_entry_point(atom(127), 284);  // go / 2
  prog->add_entry_point(atom(135), 286);  // queen / 5
  prog->add_entry_point(atom(136), 290);  // check / 8
  prog->add_entry_point(atom(137), 306);  // concat / 3
  prog->add_entry_point(atom(134), 308);  // gen / 2
}
int

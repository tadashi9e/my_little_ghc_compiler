...
Q atom(127);  // usage:  / 0
Q atom(128);  //  <N> / 0
Q atom(129);  // report_results / 2
Q atom(130);  // report_results / 3
Q atom(131);  // report1 / 3
Q atom(132);  // : / 0
Q atom(133);  // queen / 5
Q atom(134);  // check / 8
Q atom(135);  // concat / 3
      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 268:  // main/1
      ...
      MACRO_spawn(44,269);  // spawn(atom_number/2)
    case 269:  // return_from_spawn(atom_number/2)
      MACRO_par(3);
      MACRO_out_structure(atom(126),reg::out(1));
      MACRO_write_value(reg::x(2));
      MACRO_write_variable(reg::x(2));
      MACRO_spawn(6,270);  // spawn(time/1)
    case 270:  // return_from_spawn(time/1)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(50,271);  // spawn(outstream/1)
    case 271:  // return_from_spawn(outstream/1)
      MACRO_tail(4);
      MACRO_out_structure(atom(89),reg::out(1));
      MACRO_write_value(reg::x(3));
      MACRO_write_nil;
      MACRO_out_value(reg::x(2),reg::out(2));
      MACRO_execute(273,2);  // execute(report_results/2)
    case 272:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
      ...
      MACRO_write_nil;
      MACRO_execute(50,1);  // execute(outstream/1)
    case 273:  // report_results/2
      MACRO_goal(273,atom(129));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(89),reg::in(1));
      MACRO_read_variable(reg::x(3));
      MACRO_read_variable(reg::x(4));
      MACRO_activate;
      MACRO_tail(5);
      ...
      MACRO_execute(274,3);  // execute(report_results/3)
    case 274:  // report_results/3
      MACRO_goal(274,atom(130));
      MACRO_requires(11);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(89),reg::in(1));
      MACRO_read_variable(reg::x(6));
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(277,275);  // spawn(report1/3)
    case 275:  // return_from_spawn(report1/3)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(218,276);  // call(__inc__/2)
    case 276:  // return_from_call(__inc__/2)
      MACRO_tail(8);
      MACRO_out_structure(atom(89),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_value(reg::x(4));
    ...
    case 277:  // report1/3
      ...
      MACRO_unify_list;
      MACRO_unify_structure(atom(34));
      MACRO_unify_value(reg::in(2));
      MACRO_unify_value(reg::x(4));
      MACRO_proceed;
    case 278:  // go/2
      MACRO_goal(278,atom(126));
      MACRO_requires(9);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_par(4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(3),reg::out(2));
      MACRO_spawn(300,279);  // spawn(gen/2)
    case 279:  // return_from_spawn(gen/2)
      MACRO_tail(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      ...
      MACRO_execute(280,5);  // execute(queen/5)
    case 280:  // queen/5
      MACRO_goal(280,atom(133));
      MACRO_requires(17);
    ...
    case 282:  // queen/5-3
      ...
      MACRO_spawn(284,283);  // spawn(check/8)
    case 283:  // return_from_spawn(check/8)
      MACRO_tail(9);
    ...
    case 284:  // check/8
      ...
      MACRO_spawn(298,285);  // spawn(concat/3)
    case 285:  // return_from_spawn(concat/3)
      MACRO_tail(10);
    ...
    case 286:  // check/8-2
      ...
      MACRO_call(178,287);  // call(__add__/3)
    case 287:  // return_from_call(__add__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(11),reg::out(2));
      MACRO_call(166,288);  // call((=\=)/2)
    case 288:  // return_from_call((=\=)/2)
      MACRO_seq(12);
      MACRO_out_value(reg::x(10),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(10),reg::out(3));
      MACRO_call(184,289);  // call(__sub__/3)
    case 289:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(10),reg::out(2));
      MACRO_call(166,290);  // call((=\=)/2)
    case 290:  // return_from_call((=\=)/2)
      MACRO_activate;
      MACRO_par(12);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(10),reg::out(2));
      MACRO_call(218,291);  // call(__inc__/2)
    case 291:  // return_from_call(__inc__/2)
      MACRO_tail(12);
      MACRO_out_value(reg::x(9),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      ...
      MACRO_execute(284,8);  // execute(check/8)
    case 292:  // check/8-3
    ...
    case 295:  // check/8-4
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(9),reg::out(3));
      MACRO_call(184,296);  // call(__sub__/3)
    case 296:  // return_from_call(__sub__/3)
      MACRO_seq(12);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_value(reg::x(9),reg::out(2));
      MACRO_call(163,297);  // call((=:=)/2)
    case 297:  // return_from_call((=:=)/2)
      MACRO_activate;
      MACRO_get_value(reg::in(8),reg::in(7));
      MACRO_proceed;
    case 298:  // concat/3
      MACRO_goal(298,atom(135));
      MACRO_requires(9);
    ...
    case 301:  // return_from_call((>)/2)
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(4),reg::out(2));
      MACRO_call(222,302);  // call(__dec__/2)
    case 302:  // return_from_call(__dec__/2)
      MACRO_tail(5);
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
    ...
    case 303:  // gen/2-2
      ...
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_out_constant(tagvalue<TAG_INT>(0),reg::out(2));
      MACRO_call(170,304);  // call((:=)/2)
    case 304:  // return_from_call((:=)/2)
      MACRO_seq(5);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_call(163,305);  // call((=:=)/2)
...
void setup(Program* prog) {
  ...
  atom(126) = to_atom("go", 2);
  atom(127) = to_atom("usage: ", 0);
  atom(128) = to_atom(" <N>", 0);
  atom(129) = to_atom("report_results", 2);
  atom(130) = to_atom("report_results", 3);
  atom(131) = to_atom("report1", 3);
  atom(132) = to_atom(":", 0);
  atom(133) = to_atom("queen", 5);
  atom(134) = to_atom("check", 8);
  atom(135) = to_atom("concat", 3);
  atom(136) = to_atom("gen", 2);
  // setup entry points
  ...
  prog->add_entry_point(atom(125), 268);  // main / 1
  prog->add_entry_point(atom(129), 273);  // report_results / 2
  prog->add_entry_point(atom(130), 274);  // report_results / 3
  prog->add_entry_point(atom(131), 277);  // report1 / 3
  prog->add_entry_point(atom(126), 278);  // go / 2
  prog->add_entry_point(atom(133), 280);  // queen / 5
  prog->add_entry_point(atom(134), 284);  // check / 8
  prog->add_entry_point(atom(135), 298);  // concat / 3
  prog->add_entry_point(atom(136), 300);  // gen / 2
}
int

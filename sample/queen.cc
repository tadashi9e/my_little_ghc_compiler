      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 288:  // queen/5-3
      ...
      MACRO_out_variable(reg::x(8),reg::out(8));
    ...
    case 292:  // check/8-2
      ...
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(11),reg::out(3));
    ...
    case 294:  // return_from_call((=\=)/2)
      ...
      MACRO_out_value(reg::x(10),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_variable(reg::x(10),reg::out(3));

      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 275:  // tarai/4-2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(5),reg::out(2));
      MACRO_call(227,276,atom(108));  // call(__dec__/2)
    case 276:  // return_from_call(__dec__/2)
      MACRO_par(4,7);
      MACRO_out_value(reg::y(5),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
    ...
    case 277:  // return_from_spawn(tarai/4)
      ...
      MACRO_call(227,278,atom(108));  // call(__dec__/2)
    case 278:  // return_from_call(__dec__/2)
      MACRO_par(4,9);

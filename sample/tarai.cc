      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 268:  // tarai/4-2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(5),reg::out(2));
      MACRO_call(220,269);  // call(__dec__/2)
    case 269:  // return_from_call(__dec__/2)
      ...
      MACRO_spawn(266,270);  // spawn(tarai/4)
    case 270:  // return_from_spawn(tarai/4)
      MACRO_par(7);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_variable(reg::x(6),reg::out(2));
      MACRO_call(220,271);  // call(__dec__/2)
    case 271:  // return_from_call(__dec__/2)
      ...
      MACRO_spawn(266,272);  // spawn(tarai/4)
    case 272:  // return_from_spawn(tarai/4)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(220,273);  // call(__dec__/2)
    case 273:  // return_from_call(__dec__/2)
      ...
      MACRO_spawn(266,274);  // spawn(tarai/4)
    ...
    case 281:  // return_from_spawn(wait_time/1)
      ...
      MACRO_spawn(266,282);  // spawn(tarai/4)
    case 282:  // return_from_spawn(tarai/4)
      MACRO_tail(6);
      MACRO_out_constant(atom(126),reg::out(1));
      MACRO_execute(260,1);  // execute(dump_to_dot/1)
    case 283:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));

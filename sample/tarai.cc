      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    case 269:  // tarai/4
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_call(165,270,atom(84));  // call((=<)/2)
    ...
    case 271:  // tarai/4-2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(5),reg::out(2));
      MACRO_spawn(223,272,atom(108));  // spawn(__dec__/2)
    case 272:  // return_from_spawn(__dec__/2)
      MACRO_par(4,7);
      MACRO_out_value(reg::y(5),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_variable(reg::y(6),reg::out(4));
      MACRO_spawn(269,273,atom(126));  // spawn(tarai/4)
    case 273:  // return_from_spawn(tarai/4)
      MACRO_par(2,8);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_variable(reg::y(7),reg::out(2));
      MACRO_spawn(223,274,atom(108));  // spawn(__dec__/2)
    case 274:  // return_from_spawn(__dec__/2)
      MACRO_par(4,9);
      MACRO_out_value(reg::y(7),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_value(reg::in(1),reg::out(3));
      MACRO_out_variable(reg::y(8),reg::out(4));
      MACRO_spawn(269,275,atom(126));  // spawn(tarai/4)
    case 275:  // return_from_spawn(tarai/4)
      MACRO_par(2,10);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::y(9),reg::out(2));
      MACRO_spawn(223,276,atom(108));  // spawn(__dec__/2)
    case 276:  // return_from_spawn(__dec__/2)
      ...
      MACRO_spawn(269,277,atom(126));  // spawn(tarai/4)
    case 277:  // return_from_spawn(tarai/4)
      ...
      MACRO_out_value(reg::in(4),reg::out(4));
      MACRO_execute(269,4);  // execute(tarai/4)
    case 278:  // report/1
      MACRO_goal(278,atom(127));
      MACRO_requires(4);
      MACRO_try_guard_else_suspend;
      MACRO_wait(reg::in(1));
      MACRO_activate;
    ...
    case 279:  // main/1
      ...
      MACRO_spawn(48,280,atom(26));  // spawn(atom_number/2)
    ...
    case 281:  // return_from_spawn(atom_number/2)
      ...
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_variable(reg::y(4),reg::out(2));
      MACRO_spawn(48,282,atom(26));  // spawn(atom_number/2)
    case 282:  // return_from_spawn(atom_number/2)
      MACRO_par(1,6);
      MACRO_out_variable(reg::y(5),reg::out(1));
      MACRO_spawn(278,283,atom(127));  // spawn(report/1)
    case 283:  // return_from_spawn(report/1)
      MACRO_par(1,6);
      MACRO_out_value(reg::y(5),reg::out(1));
      MACRO_spawn(13,284,atom(9));  // spawn(wait_time/1)
    case 284:  // return_from_spawn(wait_time/1)
      MACRO_par(4,6);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(3),reg::out(2));
      MACRO_out_value(reg::y(4),reg::out(3));
      MACRO_out_value(reg::y(5),reg::out(4));
      MACRO_spawn(269,285,atom(126));  // spawn(tarai/4)
    case 285:  // return_from_spawn(tarai/4)
      MACRO_tail(1,6);
      MACRO_out_constant(atom(129),reg::out(1));
      MACRO_execute(263,1);  // execute(dump_to_dot/1)
    case 286:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(6));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(126), 269);  // tarai / 4
  prog->add_entry_point(atom(127), 278);  // report / 1
  prog->add_entry_point(atom(128), 279);  // main / 1
}
int

...
void module(VM::ptr vm, Program* prog, bool setup) {
  if (setup) {
    ...
    prog->add_entry_point(atom(121), &&L264);  // tarai / 4
    prog->add_entry_point(atom(122), &&L273);  // report / 1
    prog->add_entry_point(atom(123), &&L274);  // main / 1
    vm->FAIL = &&LFAIL;
    vm->FAIL2 = &&LFAIL2;
    vm->FAIL3 = &&LFAIL3;
 ...
 L264:  // tarai/4
  ...
  MACRO_requires(12);
  MACRO_try_guard_else(L266);
  MACRO_seq(6);
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_call(L156, L265);  // call((=<)/2)
 L265:  // return_from_call((=<)/2)
  MACRO_activate;
 ...
 L266:  // tarai/4-2
  ...
  MACRO_out_value(reg::in(1),reg::out(1));
  MACRO_out_variable(reg::x(5),reg::out(2));
  MACRO_call(L218, L267);  // call(__dec__/2)
 L267:  // return_from_call(__dec__/2)
  MACRO_par(6);
  MACRO_out_value(reg::x(5),reg::out(1));
  MACRO_out_value(reg::in(2),reg::out(2));
  MACRO_out_value(reg::in(3),reg::out(3));
  MACRO_out_variable(reg::x(5),reg::out(4));
  MACRO_spawn(L264, L268);  // spawn(tarai/4)
 L268:  // return_from_spawn(tarai/4)
  MACRO_par(7);
  MACRO_out_value(reg::in(2),reg::out(1));
  MACRO_out_variable(reg::x(6),reg::out(2));
  MACRO_call(L218, L269);  // call(__dec__/2)
 L269:  // return_from_call(__dec__/2)
  ...
  MACRO_spawn(L264, L270);  // spawn(tarai/4)
 L270:  // return_from_spawn(tarai/4)
  MACRO_par(8);
  MACRO_out_value(reg::in(3),reg::out(1));
  MACRO_out_variable(reg::x(7),reg::out(2));
  MACRO_call(L218, L271);  // call(__dec__/2)
 L271:  // return_from_call(__dec__/2)
  ...
  MACRO_spawn(L264, L272);  // spawn(tarai/4)
 L272:  // return_from_spawn(tarai/4)
  ...
  MACRO_out_value(reg::in(4),reg::out(4));
  MACRO_execute(L264, 4);  // execute(tarai/4)
 L273:  // report/1
  MACRO_goal(L273, atom(122));
  MACRO_requires(3);
  MACRO_try_guard_else_suspend;
  MACRO_wait(reg::in(1));
  MACRO_activate;
 ...
 L274:  // main/1
  ...
  MACRO_spawn(L40, L275);  // spawn(atom_number/2)
 L275:  // return_from_spawn(atom_number/2)
  MACRO_par(5);
  MACRO_out_value(reg::x(3),reg::out(1));
  MACRO_out_variable(reg::x(3),reg::out(2));
 ...
 L277:  // return_from_spawn(atom_number/2)
  MACRO_par(6);
  MACRO_out_variable(reg::x(5),reg::out(1));
  MACRO_spawn(L273, L278);  // spawn(report/1)
 L278:  // return_from_spawn(report/1)
  MACRO_par(6);
  MACRO_out_value(reg::x(5),reg::out(1));
  MACRO_spawn(L7, L279);  // spawn(wait_time/1)
 L279:  // return_from_spawn(wait_time/1)
  MACRO_par(6);
  MACRO_out_value(reg::x(2),reg::out(1));
  MACRO_out_value(reg::x(3),reg::out(2));
  MACRO_out_value(reg::x(4),reg::out(3));
  MACRO_out_value(reg::x(5),reg::out(4));
  MACRO_spawn(L264, L280);  // spawn(tarai/4)
 L280:  // return_from_spawn(tarai/4)
  MACRO_tail(6);
  MACRO_out_constant(atom(124),reg::out(1));
  MACRO_execute(L258, 1);  // execute(dump_to_dot/1)
 L281:  // main/1-2
  MACRO_otherwise;
  MACRO_check_list(reg::in(1));
  MACRO_read_variable(reg::x(2));

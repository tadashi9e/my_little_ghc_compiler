      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 270:  // tarai/4-2
      ...
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(5),reg::out(2));
      MACRO_call(222,271);  // call(__dec__/2)
    case 271:  // return_from_call(__dec__/2)
      ...
      MACRO_spawn(268,272);  // spawn(tarai/4)
    case 272:  // return_from_spawn(tarai/4)
      MACRO_par(7);
      MACRO_out_value(reg::in(2),reg::out(1));
      MACRO_out_variable(reg::x(6),reg::out(2));
      MACRO_call(222,273);  // call(__dec__/2)
    case 273:  // return_from_call(__dec__/2)
      MACRO_par(7);
      MACRO_out_value(reg::x(6),reg::out(1));
      MACRO_out_value(reg::in(3),reg::out(2));
      MACRO_out_value(reg::in(1),reg::out(3));
      MACRO_out_variable(reg::x(6),reg::out(4));
      MACRO_spawn(268,274);  // spawn(tarai/4)
    case 274:  // return_from_spawn(tarai/4)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(222,275);  // call(__dec__/2)
    case 275:  // return_from_call(__dec__/2)
      MACRO_par(8);
      MACRO_out_value(reg::x(7),reg::out(1));
      MACRO_out_value(reg::in(1),reg::out(2));
      MACRO_out_value(reg::in(2),reg::out(3));
      MACRO_out_variable(reg::x(7),reg::out(4));
      MACRO_spawn(268,276);  // spawn(tarai/4)
    case 276:  // return_from_spawn(tarai/4)
      ...
      MACRO_out_value(reg::in(4),reg::out(4));
      MACRO_execute(268,4);  // execute(tarai/4)
    case 277:  // report/1
      MACRO_goal(277,atom(126));
      MACRO_requires(3);
      MACRO_try_guard_else_suspend;
      MACRO_wait(reg::in(1));
      MACRO_activate;
    ...
    case 278:  // main/1
      ...
      MACRO_spawn(44,279);  // spawn(atom_number/2)
    ...
    case 281:  // return_from_spawn(atom_number/2)
      MACRO_par(6);
      MACRO_out_variable(reg::x(5),reg::out(1));
      MACRO_spawn(277,282);  // spawn(report/1)
    case 282:  // return_from_spawn(report/1)
      MACRO_par(6);
      MACRO_out_value(reg::x(5),reg::out(1));
      MACRO_spawn(9,283);  // spawn(wait_time/1)
    case 283:  // return_from_spawn(wait_time/1)
      MACRO_par(6);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_out_value(reg::x(4),reg::out(3));
      MACRO_out_value(reg::x(5),reg::out(4));
      MACRO_spawn(268,284);  // spawn(tarai/4)
    case 284:  // return_from_spawn(tarai/4)
      MACRO_tail(6);
      MACRO_out_constant(atom(128),reg::out(1));
      MACRO_execute(262,1);  // execute(dump_to_dot/1)
    case 285:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
...
void setup(Program* prog) {
  ...
  atom(125) = to_atom("tarai", 4);
  atom(126) = to_atom("report", 1);
  atom(127) = to_atom("main", 1);
  atom(128) = to_atom("dump/tarai.dot", 0);
  ...
  prog->add_entry_point(atom(125), 268);  // tarai / 4
  prog->add_entry_point(atom(126), 277);  // report / 1
  prog->add_entry_point(atom(127), 278);  // main / 1
}
int

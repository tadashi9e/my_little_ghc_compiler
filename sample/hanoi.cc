      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 265:  // return_from_spawn(atom_number/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(46,266);  // spawn(outstream/1)
    case 266:  // return_from_spawn(outstream/1)
      MACRO_par(4);
      MACRO_out_structure(atom(85),reg::out(1));
      MACRO_write_value(reg::x(3));
      MACRO_write_nil;
      MACRO_out_variable(reg::x(3),reg::out(2));
      MACRO_spawn(270,267);  // spawn(report_results/2)
    case 267:  // return_from_spawn(report_results/2)
      MACRO_par(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_spawn(7,268);  // spawn(wait_time/1)
    case 268:  // return_from_spawn(wait_time/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(275,2);  // execute(go/2)
    case 269:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
    ...
    case 270:  // report_results/2
      ...
      MACRO_execute(271,3);  // execute(report_results/3)
    case 271:  // report_results/3
      MACRO_goal(271,atom(125));
      MACRO_requires(11);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(85),reg::in(1));
      MACRO_read_variable(reg::x(6));
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(274,272);  // spawn(report1/3)
    case 272:  // return_from_spawn(report1/3)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(214,273);  // call(__inc__/2)
    case 273:  // return_from_call(__inc__/2)
      MACRO_tail(8);
      MACRO_out_structure(atom(85),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_value(reg::x(4));
    ...
    case 275:  // go/2
      ...
      MACRO_execute(276,6);  // execute(move/6)
    case 276:  // move/6
      MACRO_goal(276,atom(132));
      MACRO_requires(15);
    ...
    case 277:  // move/6-2
      ...
      MACRO_call(157,278);  // call((>)/2)
    case 278:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_par(8);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(218,279);  // call(__dec__/2)
    case 279:  // return_from_call(__dec__/2)
      MACRO_par(9);
      ...
      MACRO_spawn(276,280);  // spawn(move/6)
    case 280:  // return_from_spawn(move/6)
      MACRO_tail(9);
      MACRO_out_value(reg::x(7),reg::out(1));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(124), 270);  // report_results / 2
  prog->add_entry_point(atom(125), 271);  // report_results / 3
  prog->add_entry_point(atom(126), 274);  // report1 / 3
  prog->add_entry_point(atom(128), 275);  // go / 2
  prog->add_entry_point(atom(132), 276);  // move / 6
}
int

      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 267:  // return_from_spawn(atom_number/2)
      MACRO_par(4);
      MACRO_out_variable(reg::x(3),reg::out(1));
      MACRO_spawn(48,268);  // spawn(outstream/1)
    case 268:  // return_from_spawn(outstream/1)
      MACRO_par(4);
      MACRO_out_structure(atom(87),reg::out(1));
      MACRO_write_value(reg::x(3));
      MACRO_write_nil;
      MACRO_out_variable(reg::x(3),reg::out(2));
      MACRO_spawn(272,269);  // spawn(report_results/2)
    case 269:  // return_from_spawn(report_results/2)
      MACRO_par(4);
      MACRO_out_value(reg::x(3),reg::out(1));
      MACRO_spawn(7,270);  // spawn(wait_time/1)
    case 270:  // return_from_spawn(wait_time/1)
      MACRO_tail(4);
      MACRO_out_value(reg::x(2),reg::out(1));
      MACRO_out_value(reg::x(3),reg::out(2));
      MACRO_execute(277,2);  // execute(go/2)
    case 271:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(2));
      ...
      MACRO_write_nil;
      MACRO_execute(48,1);  // execute(outstream/1)
    case 272:  // report_results/2
      MACRO_goal(272,atom(126));
      MACRO_requires(8);
      MACRO_try_guard_else_suspend;
      ...
      MACRO_execute(273,3);  // execute(report_results/3)
    case 273:  // report_results/3
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(276,274);  // spawn(report1/3)
    case 274:  // return_from_spawn(report1/3)
      MACRO_par(8);
      MACRO_out_value(reg::in(3),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(216,275);  // call(__inc__/2)
    case 275:  // return_from_call(__inc__/2)
      MACRO_tail(8);
      MACRO_out_structure(atom(87),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_value(reg::x(4));
    ...
    case 277:  // go/2
      ...
      MACRO_execute(278,6);  // execute(move/6)
    case 278:  // move/6
      MACRO_goal(278,atom(134));
      MACRO_requires(15);
    ...
    case 279:  // move/6-2
      ...
      MACRO_call(159,280);  // call((>)/2)
    case 280:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_par(8);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::x(7),reg::out(2));
      MACRO_call(220,281);  // call(__dec__/2)
    case 281:  // return_from_call(__dec__/2)
      MACRO_par(9);
      ...
      MACRO_spawn(278,282);  // spawn(move/6)
    case 282:  // return_from_spawn(move/6)
      MACRO_tail(9);
      MACRO_out_value(reg::x(7),reg::out(1));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(126), 272);  // report_results / 2
  prog->add_entry_point(atom(127), 273);  // report_results / 3
  prog->add_entry_point(atom(128), 276);  // report1 / 3
  prog->add_entry_point(atom(130), 277);  // go / 2
  prog->add_entry_point(atom(134), 278);  // move / 6
}
int

      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 274:  // return_from_spawn(atom_number/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(54,275,atom(29));  // spawn(outstream/1)
    case 275:  // return_from_spawn(outstream/1)
      ...
      MACRO_write_nil;
      MACRO_out_variable(reg::y(4),reg::out(2));
      MACRO_spawn(279,276,atom(127));  // spawn(report_results/2)
    case 276:  // return_from_spawn(report_results/2)
      MACRO_par(1,5);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_spawn(13,277,atom(9));  // spawn(wait_time/1)
    case 277:  // return_from_spawn(wait_time/1)
      MACRO_tail(2,5);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(4),reg::out(2));
      MACRO_execute(284,2);  // execute(go/2)
    case 278:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(5));
    ...
    case 280:  // report_results/3
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(283,281,atom(131));  // spawn(report1/3)
    ...
    case 283:  // report1/3
      ...
      MACRO_proceed;
    case 284:  // go/2
      MACRO_goal(284,atom(133));
      MACRO_requires(13);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_tail(6,7);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(atom(134),reg::out(2));
      MACRO_out_constant(atom(135),reg::out(3));
      MACRO_out_constant(atom(136),reg::out(4));
      MACRO_out_value(reg::in(2),reg::out(5));
      MACRO_out_nil(reg::out(6));
      MACRO_execute(285,6);  // execute(move/6)
    case 285:  // move/6
      MACRO_goal(285,atom(137));
      MACRO_requires(15);
    ...
    case 286:  // move/6-2
      ...
      MACRO_call(166,287,atom(85));  // call((>)/2)
    case 287:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_par(2,8);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(7),reg::out(2));
      MACRO_spawn(227,288,atom(108));  // spawn(__dec__/2)
    case 288:  // return_from_spawn(__dec__/2)
      MACRO_par(6,9);
      ...
      MACRO_write_structure(atom(138));
      MACRO_write_value(reg::in(2));
      MACRO_write_value(reg::in(3));
      MACRO_write_variable(reg::x(8));
      MACRO_spawn(285,289,atom(137));  // spawn(move/6)
    case 289:  // return_from_spawn(move/6)
      MACRO_tail(6,9);
      MACRO_out_value(reg::y(7),reg::out(1));
      MACRO_out_value(reg::in(4),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::in(2),reg::out(4));
      MACRO_out_value(reg::x(8),reg::out(5));
...
void setup(Program* prog) {
  ...
  atom(132) = to_atom(":", 0);
  atom(133) = to_atom("go", 2);
  atom(134) = to_atom("left", 0);
  atom(135) = to_atom("center", 0);
  atom(136) = to_atom("right", 0);
  atom(137) = to_atom("move", 6);
  atom(138) = to_atom("m", 2);
  // setup entry points
  ...
  prog->add_entry_point(atom(127), 279);  // report_results / 2
  prog->add_entry_point(atom(130), 280);  // report_results / 3
  prog->add_entry_point(atom(131), 283);  // report1 / 3
  prog->add_entry_point(atom(133), 284);  // go / 2
  prog->add_entry_point(atom(137), 285);  // move / 6
}
int

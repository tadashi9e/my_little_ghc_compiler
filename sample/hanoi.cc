      ...
      MACRO_requires(1);
{
  ...
  MACRO_proceed;
    ...
    case 270:  // return_from_spawn(atom_number/2)
      MACRO_par(1,4);
      MACRO_out_variable(reg::y(3),reg::out(1));
      MACRO_spawn(54,271,atom(29));  // spawn(outstream/1)
    case 271:  // return_from_spawn(outstream/1)
      ...
      MACRO_write_nil;
      MACRO_out_variable(reg::y(4),reg::out(2));
      MACRO_spawn(275,272,atom(127));  // spawn(report_results/2)
    case 272:  // return_from_spawn(report_results/2)
      MACRO_par(1,5);
      MACRO_out_value(reg::y(4),reg::out(1));
      MACRO_spawn(13,273,atom(9));  // spawn(wait_time/1)
    case 273:  // return_from_spawn(wait_time/1)
      MACRO_tail(2,5);
      MACRO_out_value(reg::y(2),reg::out(1));
      MACRO_out_value(reg::y(4),reg::out(2));
      MACRO_execute(280,2);  // execute(go/2)
    case 274:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(5));
    ...
    case 276:  // report_results/3
      ...
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(279,277,atom(131));  // spawn(report1/3)
    ...
    case 280:  // go/2
      ...
      MACRO_execute(281,6);  // execute(move/6)
    case 281:  // move/6
      MACRO_goal(281,atom(137));
      MACRO_requires(15);
    ...
    case 282:  // move/6-2
      ...
      MACRO_call(166,283,atom(85));  // call((>)/2)
    case 283:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_par(2,8);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_variable(reg::y(7),reg::out(2));
      MACRO_spawn(223,284,atom(108));  // spawn(__dec__/2)
    case 284:  // return_from_spawn(__dec__/2)
      MACRO_par(6,9);
      ...
      MACRO_spawn(281,285,atom(137));  // spawn(move/6)
    case 285:  // return_from_spawn(move/6)
      MACRO_tail(6,9);
      MACRO_out_value(reg::y(7),reg::out(1));
...
void setup(Program* prog) {
  ...
  prog->add_entry_point(atom(127), 275);  // report_results / 2
  prog->add_entry_point(atom(130), 276);  // report_results / 3
  prog->add_entry_point(atom(131), 279);  // report1 / 3
  prog->add_entry_point(atom(133), 280);  // go / 2
  prog->add_entry_point(atom(137), 281);  // move / 6
}
int

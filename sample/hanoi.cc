...
Q atom(118);  // usage:  / 0
Q atom(119);  //  <N> / 0
Q atom(120);  // report_results / 2
Q atom(121);  // report_results / 3
Q atom(122);  // report1 / 3
Q atom(123);  // : / 0
Q atom(124);  // go / 2
Q atom(125);  // left / 0
Q atom(126);  // center / 0
      ...
      MACRO_requires(5);
{
  ...
  MACRO_proceed;
    ...
    case 255:  // return_from_spawn(atom_number/2)
      MACRO_par(7);
      MACRO_out_variable(reg::x(6),reg::out(1));
      MACRO_spawn(46,256);  // spawn(outstream/1)
    case 256:  // return_from_spawn(outstream/1)
      MACRO_par(9);
      MACRO_out_structure(atom(85),reg::out(1));
      MACRO_write_value(reg::x(6));
      MACRO_write_nil;
      MACRO_out_variable(reg::x(8),reg::out(2));
      MACRO_spawn(260,257);  // spawn(report_results/2)
    case 257:  // return_from_spawn(report_results/2)
      MACRO_par(9);
      MACRO_out_value(reg::x(8),reg::out(1));
      MACRO_spawn(7,258);  // spawn(wait_time/1)
    case 258:  // return_from_spawn(wait_time/1)
      MACRO_tail(9);
      MACRO_out_value(reg::x(4),reg::out(1));
      MACRO_out_value(reg::x(8),reg::out(2));
      MACRO_execute(265,2);  // execute(go/2)
    case 259:  // main/1-2
      MACRO_otherwise;
      MACRO_check_list(reg::in(1));
      MACRO_read_variable(reg::x(10));
      ...
      MACRO_write_nil;
      MACRO_execute(46,1);  // execute(outstream/1)
    case 260:  // report_results/2
      MACRO_goal(260,atom(120));
      MACRO_requires(9);
      MACRO_try_guard_else_suspend;
      ...
      MACRO_execute(261,3);  // execute(report_results/3)
    case 261:  // report_results/3
      MACRO_goal(261,atom(121));
      MACRO_requires(18);
      MACRO_try_guard_else_suspend;
      MACRO_check_structure(atom(85),reg::in(1));
      MACRO_read_variable(reg::x(4));
      ...
      MACRO_out_value(reg::x(8),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_spawn(264,262);  // spawn(report1/3)
    case 262:  // return_from_spawn(report1/3)
      MACRO_par(15);
      MACRO_out_variable(reg::x(14),reg::out(1));
      MACRO_out_structure(atom(38),reg::out(2));
      MACRO_write_value(reg::in(3));
      MACRO_write_constant(tagvalue<TAG_INT>(1));
      MACRO_spawn(166,263);  // spawn((:=)/2)
    case 263:  // return_from_spawn((:=)/2)
      MACRO_tail(15);
      MACRO_out_structure(atom(85),reg::out(1));
    ...
    case 264:  // report1/3
      ...
      MACRO_proceed;
    case 265:  // go/2
      MACRO_goal(265,atom(124));
      MACRO_requires(9);
      MACRO_try_guard_else_suspend;
      MACRO_activate;
      MACRO_tail(4);
      MACRO_out_value(reg::in(1),reg::out(1));
      MACRO_out_constant(atom(125),reg::out(2));
      MACRO_out_constant(atom(126),reg::out(3));
      MACRO_out_constant(atom(127),reg::out(4));
      MACRO_out_value(reg::in(2),reg::out(5));
      MACRO_out_nil(reg::out(6));
      MACRO_execute(266,6);  // execute(move/6)
    case 266:  // move/6
      MACRO_goal(266,atom(128));
      MACRO_requires(16);
      MACRO_try_guard_else(267);
      MACRO_check_constant(tagvalue<TAG_INT>(0),reg::in(1));
      MACRO_activate;
      MACRO_get_value(reg::in(6),reg::in(5));
      MACRO_proceed;
    case 267:  // move/6-2
      MACRO_try_guard_else_suspend;
      MACRO_seq(8);
      ...
      MACRO_call(157,268);  // call((>)/2)
    case 268:  // return_from_call((>)/2)
      MACRO_activate;
      MACRO_par(8);
      MACRO_out_variable(reg::x(7),reg::out(1));
      MACRO_out_structure(atom(85),reg::out(2));
      MACRO_write_value(reg::in(1));
      MACRO_write_constant(tagvalue<TAG_INT>(1));
      MACRO_spawn(166,269);  // spawn((:=)/2)
    case 269:  // return_from_spawn((:=)/2)
      MACRO_par(10);
      MACRO_out_value(reg::x(7),reg::out(1));
      MACRO_out_value(reg::in(2),reg::out(2));
      MACRO_out_value(reg::in(4),reg::out(3));
      MACRO_out_value(reg::in(3),reg::out(4));
      MACRO_out_value(reg::in(5),reg::out(5));
      MACRO_out_list(reg::out(6));
      MACRO_write_structure(atom(129));
      MACRO_write_value(reg::in(2));
      MACRO_write_value(reg::in(3));
      MACRO_write_variable(reg::x(9));
      MACRO_spawn(266,270);  // spawn(move/6)
    case 270:  // return_from_spawn(move/6)
      MACRO_tail(10);
      MACRO_out_value(reg::x(7),reg::out(1));
      MACRO_out_value(reg::in(4),reg::out(2));
      MACRO_out_value(reg::in(3),reg::out(3));
      MACRO_out_value(reg::in(2),reg::out(4));
      MACRO_out_value(reg::x(9),reg::out(5));
...
void setup(Program* prog) {
  ...
  atom(118) = to_atom("usage: ", 0);
  atom(119) = to_atom(" <N>", 0);
  atom(120) = to_atom("report_results", 2);
  atom(121) = to_atom("report_results", 3);
  atom(122) = to_atom("report1", 3);
  atom(123) = to_atom(":", 0);
  atom(124) = to_atom("go", 2);
  atom(125) = to_atom("left", 0);
  atom(126) = to_atom("center", 0);
  atom(127) = to_atom("right", 0);
  atom(128) = to_atom("move", 6);
  atom(129) = to_atom("m", 2);
  // setup entry points
  ...
  prog->add_entry_point(atom(120), 260);  // report_results / 2
  prog->add_entry_point(atom(121), 261);  // report_results / 3
  prog->add_entry_point(atom(122), 264);  // report1 / 3
  prog->add_entry_point(atom(124), 265);  // go / 2
  prog->add_entry_point(atom(128), 266);  // move / 6
}
int
